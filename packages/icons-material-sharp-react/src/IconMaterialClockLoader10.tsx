...
const IconMaterialClockLoader10 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialClockLoader10.displayName = 'OnesyIconMaterialClockLoader10';

export default IconMaterialClockLoader10;
