...
const IconMaterialVpnLock2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialVpnLock2.displayName = 'OnesyIconMaterialVpnLock2';

export default IconMaterialVpnLock2;
