...
const IconMaterialAddTaskW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAddTaskW100.displayName = 'OnesyIconMaterialAddTaskW100';

export default IconMaterialAddTaskW100;
