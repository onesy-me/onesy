...
const IconMaterialDirectorySync = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDirectorySync.displayName = 'OnesyIconMaterialDirectorySync';

export default IconMaterialDirectorySync;
