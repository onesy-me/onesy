...
const IconMaterialBrandFamily = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBrandFamily.displayName = 'OnesyIconMaterialBrandFamily';

export default IconMaterialBrandFamily;
