...
const IconMaterialMotionSensorActiveFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorActiveFilled'
...
IconMaterialMotionSensorActiveFilled.displayName = 'OnesyIconMaterialMotionSensorActiveFilled';

export default IconMaterialMotionSensorActiveFilled;
