...
const IconMaterialTonality2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTonality2.displayName = 'OnesyIconMaterialTonality2';

export default IconMaterialTonality2;
