...
const IconMaterialSyncProblemW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SyncProblemW100Filled'
...
IconMaterialSyncProblemW100Filled.displayName = 'OnesyIconMaterialSyncProblemW100Filled';

export default IconMaterialSyncProblemW100Filled;
