...
const IconMaterialOutpatientMedW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="m772-376-20-20 70-70H659v-27h163l-70-69 21-21 103 103-104 104ZM125-748v-28h376v28H125Zm148 468h80v-100h100v-80H353v-100h-80v100H173v80h100v100ZM85-172v-496h456v496H85Z"/>
    </Icon>
  );
});
