...
const IconMaterialNestProtectFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestProtectFilled'
...
IconMaterialNestProtectFilled.displayName = 'OnesyIconMaterialNestProtectFilled';

export default IconMaterialNestProtectFilled;
