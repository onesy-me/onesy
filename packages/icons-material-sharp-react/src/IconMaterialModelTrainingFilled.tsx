...
const IconMaterialModelTrainingFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModelTrainingFilled'
...
IconMaterialModelTrainingFilled.displayName = 'OnesyIconMaterialModelTrainingFilled';

export default IconMaterialModelTrainingFilled;
