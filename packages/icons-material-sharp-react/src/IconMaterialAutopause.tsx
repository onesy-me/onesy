...
const IconMaterialAutopause = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutopause.displayName = 'OnesyIconMaterialAutopause';

export default IconMaterialAutopause;
