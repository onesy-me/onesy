...
const IconMaterialTacticW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTacticW100.displayName = 'OnesyIconMaterialTacticW100';

export default IconMaterialTacticW100;
