...
const IconMaterialEndocrinologyW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EndocrinologyW100'
...
export default IconMaterialEndocrinologyW100;
