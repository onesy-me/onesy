...
const IconMaterialEraserSize3W100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EraserSize3W100Filled'
...
IconMaterialEraserSize3W100Filled.displayName = 'OnesyIconMaterialEraserSize3W100Filled';

export default IconMaterialEraserSize3W100Filled;
