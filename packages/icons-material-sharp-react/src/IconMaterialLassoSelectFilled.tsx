...
const IconMaterialLassoSelectFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LassoSelectFilled'
...
IconMaterialLassoSelectFilled.displayName = 'OnesyIconMaterialLassoSelectFilled';

export default IconMaterialLassoSelectFilled;
