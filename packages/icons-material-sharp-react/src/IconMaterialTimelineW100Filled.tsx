...
const IconMaterialTimelineW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TimelineW100Filled'
...
IconMaterialTimelineW100Filled.displayName = 'OnesyIconMaterialTimelineW100Filled';

export default IconMaterialTimelineW100Filled;
