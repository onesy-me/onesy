...
const IconMaterialAndroidCell5BarAlert = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAndroidCell5BarAlert.displayName = 'OnesyIconMaterialAndroidCell5BarAlert';

export default IconMaterialAndroidCell5BarAlert;
