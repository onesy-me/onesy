...
const IconMaterialMicNoiseCancelOffW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicNoiseCancelOffW100'
...
IconMaterialMicNoiseCancelOffW100.displayName = 'OnesyIconMaterialMicNoiseCancelOffW100';

export default IconMaterialMicNoiseCancelOffW100;
