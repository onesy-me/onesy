...
const IconMaterialSpeed17xW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSpeed17xW100.displayName = 'OnesyIconMaterialSpeed17xW100';

export default IconMaterialSpeed17xW100;
