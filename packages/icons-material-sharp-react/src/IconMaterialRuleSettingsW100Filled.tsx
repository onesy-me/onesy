...
const IconMaterialRuleSettingsW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RuleSettingsW100Filled'
...
IconMaterialRuleSettingsW100Filled.displayName = 'OnesyIconMaterialRuleSettingsW100Filled';

export default IconMaterialRuleSettingsW100Filled;
