...
const IconMaterialForwardCircleW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ForwardCircleW100'
...
IconMaterialForwardCircleW100.displayName = 'OnesyIconMaterialForwardCircleW100';

export default IconMaterialForwardCircleW100;
