...
const IconMaterialNetworkNode = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNetworkNode.displayName = 'OnesyIconMaterialNetworkNode';

export default IconMaterialNetworkNode;
