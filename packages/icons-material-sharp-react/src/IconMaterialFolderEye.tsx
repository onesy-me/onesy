...
const IconMaterialFolderEye = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFolderEye.displayName = 'OnesyIconMaterialFolderEye';

export default IconMaterialFolderEye;
