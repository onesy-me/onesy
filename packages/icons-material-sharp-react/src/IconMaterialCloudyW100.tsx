...
const IconMaterialCloudyW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudyW100.displayName = 'OnesyIconMaterialCloudyW100';

export default IconMaterialCloudyW100;
