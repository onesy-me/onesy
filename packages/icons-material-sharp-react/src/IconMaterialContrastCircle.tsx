...
const IconMaterialContrastCircle = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialContrastCircle.displayName = 'OnesyIconMaterialContrastCircle';

export default IconMaterialContrastCircle;
