...
const IconMaterialPaidW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPaidW100.displayName = 'OnesyIconMaterialPaidW100';

export default IconMaterialPaidW100;
