...
const IconMaterialLiftToTalkW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLiftToTalkW100.displayName = 'OnesyIconMaterialLiftToTalkW100';

export default IconMaterialLiftToTalkW100;
