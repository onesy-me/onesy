...
const IconMaterialTibiaAlt = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTibiaAlt.displayName = 'OnesyIconMaterialTibiaAlt';

export default IconMaterialTibiaAlt;
