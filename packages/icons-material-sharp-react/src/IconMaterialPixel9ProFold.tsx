...
const IconMaterialPixel9ProFold = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPixel9ProFold.displayName = 'OnesyIconMaterialPixel9ProFold';

export default IconMaterialPixel9ProFold;
