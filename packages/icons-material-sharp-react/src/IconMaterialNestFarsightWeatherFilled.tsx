...
const IconMaterialNestFarsightWeatherFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightWeatherFilled'
...
IconMaterialNestFarsightWeatherFilled.displayName = 'OnesyIconMaterialNestFarsightWeatherFilled';

export default IconMaterialNestFarsightWeatherFilled;
