...
const IconMaterialMatterFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMatterFilled.displayName = 'OnesyIconMaterialMatterFilled';

export default IconMaterialMatterFilled;
