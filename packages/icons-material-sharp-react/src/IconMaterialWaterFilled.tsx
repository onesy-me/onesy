...
const IconMaterialWaterFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWaterFilled.displayName = 'OnesyIconMaterialWaterFilled';

export default IconMaterialWaterFilled;
