...
const IconMaterialModeOffOnFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeOffOnFilled'
...
IconMaterialModeOffOnFilled.displayName = 'OnesyIconMaterialModeOffOnFilled';

export default IconMaterialModeOffOnFilled;
