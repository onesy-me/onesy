...
const IconMaterialElderlyWomanFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ElderlyWomanFilled'
...
IconMaterialElderlyWomanFilled.displayName = 'OnesyIconMaterialElderlyWomanFilled';

export default IconMaterialElderlyWomanFilled;
