...
const IconMaterialAcupunctureFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AcupunctureFilled'
