...
const IconMaterialCrownW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCrownW100.displayName = 'OnesyIconMaterialCrownW100';

export default IconMaterialCrownW100;
