...
const IconMaterialSpeed17xFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSpeed17xFilled.displayName = 'OnesyIconMaterialSpeed17xFilled';

export default IconMaterialSpeed17xFilled;
