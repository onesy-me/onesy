...
const IconMaterialEraserSize4W100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EraserSize4W100Filled'
...
IconMaterialEraserSize4W100Filled.displayName = 'OnesyIconMaterialEraserSize4W100Filled';

export default IconMaterialEraserSize4W100Filled;
