...
const IconMaterialHistoryOff = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHistoryOff.displayName = 'OnesyIconMaterialHistoryOff';

export default IconMaterialHistoryOff;
