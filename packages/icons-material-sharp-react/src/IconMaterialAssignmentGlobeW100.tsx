...
const IconMaterialAssignmentGlobeW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AssignmentGlobeW100'
...
IconMaterialAssignmentGlobeW100.displayName = 'OnesyIconMaterialAssignmentGlobeW100';

export default IconMaterialAssignmentGlobeW100;
