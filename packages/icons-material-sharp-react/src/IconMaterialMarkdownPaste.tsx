...
const IconMaterialMarkdownPaste = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMarkdownPaste.displayName = 'OnesyIconMaterialMarkdownPaste';

export default IconMaterialMarkdownPaste;
