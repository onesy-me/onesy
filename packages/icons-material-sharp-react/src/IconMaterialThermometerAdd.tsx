...
const IconMaterialThermometerAdd = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialThermometerAdd.displayName = 'OnesyIconMaterialThermometerAdd';

export default IconMaterialThermometerAdd;
