...
const IconMaterialNoAdultContentFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoAdultContentFilled'
...
IconMaterialNoAdultContentFilled.displayName = 'OnesyIconMaterialNoAdultContentFilled';

export default IconMaterialNoAdultContentFilled;
