...
const IconMaterialMenuBookW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMenuBookW100.displayName = 'OnesyIconMaterialMenuBookW100';

export default IconMaterialMenuBookW100;
