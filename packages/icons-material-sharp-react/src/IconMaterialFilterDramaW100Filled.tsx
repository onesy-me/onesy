...
const IconMaterialFilterDramaW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M260-212q-70 0-119-49T92-380q0-69 49-118.5T260-548q69 0 118.5 49.5T428-380h28q0-83-54.5-138.5T260-576q17-77 79.5-124.5T480-748q95 0 161.5 66.5T708-520v52h32q54 0 91 37t37 91q0 53-37.5 90.5T740-212H260Z"/>
    </Icon>
  );
});
