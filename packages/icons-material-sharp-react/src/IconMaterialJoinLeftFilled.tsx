...
const IconMaterialJoinLeftFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialJoinLeftFilled.displayName = 'OnesyIconMaterialJoinLeftFilled';

export default IconMaterialJoinLeftFilled;
