...
const IconMaterialStadiaController = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialStadiaController.displayName = 'OnesyIconMaterialStadiaController';

export default IconMaterialStadiaController;
