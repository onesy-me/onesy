...
const IconMaterialSearchInsightsFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchInsightsFilled'
...
IconMaterialSearchInsightsFilled.displayName = 'OnesyIconMaterialSearchInsightsFilled';

export default IconMaterialSearchInsightsFilled;
