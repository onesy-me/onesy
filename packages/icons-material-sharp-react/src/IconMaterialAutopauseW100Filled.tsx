...
const IconMaterialAutopauseW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutopauseW100Filled'
