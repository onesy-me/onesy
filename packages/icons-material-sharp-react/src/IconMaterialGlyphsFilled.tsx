...
const IconMaterialGlyphsFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGlyphsFilled.displayName = 'OnesyIconMaterialGlyphsFilled';

export default IconMaterialGlyphsFilled;
