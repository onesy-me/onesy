...
const IconMaterialAutoModeFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutoModeFilled.displayName = 'OnesyIconMaterialAutoModeFilled';

export default IconMaterialAutoModeFilled;
