...
const IconMaterialBreastfeedingW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BreastfeedingW100'
...
IconMaterialBreastfeedingW100.displayName = 'OnesyIconMaterialBreastfeedingW100';

export default IconMaterialBreastfeedingW100;
