...
const IconMaterialFingerprintOffW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FingerprintOffW100Filled'
...
IconMaterialFingerprintOffW100Filled.displayName = 'OnesyIconMaterialFingerprintOffW100Filled';

export default IconMaterialFingerprintOffW100Filled;
