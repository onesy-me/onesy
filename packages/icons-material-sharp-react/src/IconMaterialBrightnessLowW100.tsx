...
const IconMaterialBrightnessLowW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessLowW100'
...
IconMaterialBrightnessLowW100.displayName = 'OnesyIconMaterialBrightnessLowW100';

export default IconMaterialBrightnessLowW100;
