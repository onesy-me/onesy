...
const IconMaterialEraserSize2W100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EraserSize2W100'
...
IconMaterialEraserSize2W100.displayName = 'OnesyIconMaterialEraserSize2W100';

export default IconMaterialEraserSize2W100;
