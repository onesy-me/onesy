...
const IconMaterialRotateLeftW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateLeftW100Filled'
...
IconMaterialRotateLeftW100Filled.displayName = 'OnesyIconMaterialRotateLeftW100Filled';

export default IconMaterialRotateLeftW100Filled;
