...
const IconMaterialHeadphonesBatteryW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M112-266v-216q0-86.67 60.74-147.33Q233.47-690 320.24-690q86.76 0 147.26 60.67Q528-568.67 528-482v216h-96v-168h68v-48q0-75-52.5-127.5T320-662q-75 0-127.5 52.5T140-482v48h68v168h-96Zm558 0v-396h76v-28h28v28h76v396H670Z"/>
    </Icon>
  );
});
