...
const IconMaterialBigtopUpdates = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBigtopUpdates.displayName = 'OnesyIconMaterialBigtopUpdates';

export default IconMaterialBigtopUpdates;
