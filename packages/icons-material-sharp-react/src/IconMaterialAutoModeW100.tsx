...
const IconMaterialAutoModeW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutoModeW100.displayName = 'OnesyIconMaterialAutoModeW100';

export default IconMaterialAutoModeW100;
