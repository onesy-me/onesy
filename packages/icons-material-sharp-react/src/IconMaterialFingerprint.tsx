...
const IconMaterialFingerprint = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFingerprint.displayName = 'OnesyIconMaterialFingerprint';

export default IconMaterialFingerprint;
