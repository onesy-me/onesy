...
const IconMaterialShutterSpeedAddW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ShutterSpeedAddW100'
...
IconMaterialShutterSpeedAddW100.displayName = 'OnesyIconMaterialShutterSpeedAddW100';

export default IconMaterialShutterSpeedAddW100;
