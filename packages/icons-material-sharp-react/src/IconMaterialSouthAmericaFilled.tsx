...
const IconMaterialSouthAmericaFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SouthAmericaFilled'
...
IconMaterialSouthAmericaFilled.displayName = 'OnesyIconMaterialSouthAmericaFilled';

export default IconMaterialSouthAmericaFilled;
