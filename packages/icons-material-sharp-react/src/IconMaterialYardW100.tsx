...
const IconMaterialYardW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialYardW100.displayName = 'OnesyIconMaterialYardW100';

export default IconMaterialYardW100;
