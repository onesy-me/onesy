...
const IconMaterialConversationW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConversationW100'
...
IconMaterialConversationW100.displayName = 'OnesyIconMaterialConversationW100';

export default IconMaterialConversationW100;
