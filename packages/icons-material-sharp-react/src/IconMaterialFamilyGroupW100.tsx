...
const IconMaterialFamilyGroupW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FamilyGroupW100'
...
IconMaterialFamilyGroupW100.displayName = 'OnesyIconMaterialFamilyGroupW100';

export default IconMaterialFamilyGroupW100;
