...
const IconMaterialRestartAltW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestartAltW100Filled'
...
IconMaterialRestartAltW100Filled.displayName = 'OnesyIconMaterialRestartAltW100Filled';

export default IconMaterialRestartAltW100Filled;
