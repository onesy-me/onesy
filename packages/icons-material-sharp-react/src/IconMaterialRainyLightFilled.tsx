...
const IconMaterialRainyLightFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RainyLightFilled'
...
IconMaterialRainyLightFilled.displayName = 'OnesyIconMaterialRainyLightFilled';

export default IconMaterialRainyLightFilled;
