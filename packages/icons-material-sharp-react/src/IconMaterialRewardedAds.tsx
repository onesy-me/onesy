...
const IconMaterialRewardedAds = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRewardedAds.displayName = 'OnesyIconMaterialRewardedAds';

export default IconMaterialRewardedAds;
