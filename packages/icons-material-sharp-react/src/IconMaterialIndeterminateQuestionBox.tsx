...
const IconMaterialIndeterminateQuestionBox = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialIndeterminateQuestionBox.displayName = 'OnesyIconMaterialIndeterminateQuestionBox';

export default IconMaterialIndeterminateQuestionBox;
