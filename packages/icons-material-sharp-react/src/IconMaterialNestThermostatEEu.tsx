...
const IconMaterialNestThermostatEEu = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestThermostatEEu.displayName = 'OnesyIconMaterialNestThermostatEEu';

export default IconMaterialNestThermostatEEu;
