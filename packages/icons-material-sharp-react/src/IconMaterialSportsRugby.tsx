...
const IconMaterialSportsRugby = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSportsRugby.displayName = 'OnesyIconMaterialSportsRugby';

export default IconMaterialSportsRugby;
