...
const IconMaterialResetIsoFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialResetIsoFilled.displayName = 'OnesyIconMaterialResetIsoFilled';

export default IconMaterialResetIsoFilled;
