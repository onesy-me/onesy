...
const IconMaterial24fpsSelect = React.forwardRef((props: IIcon, ref) => {
...
IconMaterial24fpsSelect.displayName = 'OnesyIconMaterial24fpsSelect';

export default IconMaterial24fpsSelect;
