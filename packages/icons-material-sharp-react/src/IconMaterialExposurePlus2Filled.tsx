...
const IconMaterialExposurePlus2Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExposurePlus2Filled'
...
IconMaterialExposurePlus2Filled.displayName = 'OnesyIconMaterialExposurePlus2Filled';

export default IconMaterialExposurePlus2Filled;
