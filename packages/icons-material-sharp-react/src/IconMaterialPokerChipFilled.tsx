...
const IconMaterialPokerChipFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PokerChipFilled'
...
IconMaterialPokerChipFilled.displayName = 'OnesyIconMaterialPokerChipFilled';

export default IconMaterialPokerChipFilled;
