...
const IconMaterialDataCheck = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDataCheck.displayName = 'OnesyIconMaterialDataCheck';

export default IconMaterialDataCheck;
