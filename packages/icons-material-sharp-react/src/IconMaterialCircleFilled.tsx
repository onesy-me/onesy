...
const IconMaterialCircleFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCircleFilled.displayName = 'OnesyIconMaterialCircleFilled';

export default IconMaterialCircleFilled;
