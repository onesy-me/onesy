...
const IconMaterialTocW100Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTocW100Filled.displayName = 'OnesyIconMaterialTocW100Filled';

export default IconMaterialTocW100Filled;
