...
const IconMaterialFlagCheck = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFlagCheck.displayName = 'OnesyIconMaterialFlagCheck';

export default IconMaterialFlagCheck;
