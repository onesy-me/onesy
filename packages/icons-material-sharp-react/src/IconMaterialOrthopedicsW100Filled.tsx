...
const IconMaterialOrthopedicsW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='OrthopedicsW100Filled'
