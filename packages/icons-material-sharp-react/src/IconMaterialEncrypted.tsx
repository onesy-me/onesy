...
const IconMaterialEncrypted = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEncrypted.displayName = 'OnesyIconMaterialEncrypted';

export default IconMaterialEncrypted;
