...
const IconMaterialShoppingBasketW100 = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M203-172 95-548h227l159-241 157 241h227L755-172H203Zm17-28h520l88-320H132l88 320Zm260-132q11 0 19.5-8.5T508-360q0-11-8.5-19.5T480-388q-11 0-19.5 8.5T452-360q0 11 8.5 19.5T480-332ZM356-548h248L480-738 356-548Zm124 188Z"/>
    </Icon>
  );
});
