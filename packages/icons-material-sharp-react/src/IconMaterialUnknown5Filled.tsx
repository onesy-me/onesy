...
const IconMaterialUnknown5Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialUnknown5Filled.displayName = 'OnesyIconMaterialUnknown5Filled';

export default IconMaterialUnknown5Filled;
