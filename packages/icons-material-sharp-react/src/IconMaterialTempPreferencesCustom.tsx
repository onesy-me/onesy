...
const IconMaterialTempPreferencesCustom = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTempPreferencesCustom.displayName = 'OnesyIconMaterialTempPreferencesCustom';

export default IconMaterialTempPreferencesCustom;
