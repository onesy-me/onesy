...
const IconMaterialReduceCapacityW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReduceCapacityW100Filled'
