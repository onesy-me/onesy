...
const IconMaterialTitlecaseW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTitlecaseW100.displayName = 'OnesyIconMaterialTitlecaseW100';

export default IconMaterialTitlecaseW100;
