...
const IconMaterialTitlecaseFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TitlecaseFilled'
...
IconMaterialTitlecaseFilled.displayName = 'OnesyIconMaterialTitlecaseFilled';

export default IconMaterialTitlecaseFilled;
