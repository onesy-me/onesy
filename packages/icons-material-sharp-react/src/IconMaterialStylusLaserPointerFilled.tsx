...
const IconMaterialStylusLaserPointerFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='StylusLaserPointerFilled'
...
IconMaterialStylusLaserPointerFilled.displayName = 'OnesyIconMaterialStylusLaserPointerFilled';

export default IconMaterialStylusLaserPointerFilled;
