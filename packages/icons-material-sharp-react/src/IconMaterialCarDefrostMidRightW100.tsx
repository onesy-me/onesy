...
const IconMaterialCarDefrostMidRightW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CarDefrostMidRightW100'
...
IconMaterialCarDefrostMidRightW100.displayName = 'OnesyIconMaterialCarDefrostMidRightW100';

export default IconMaterialCarDefrostMidRightW100;
