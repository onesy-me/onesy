...
const IconMaterialStackStarW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="m533-263 67-41 67 41-18-77 59-50-77.14-6.64L600-469l-30.86 72.36L492-390l59 50-18 77ZM272-400v28H132v-456h456v140h-28v-112H160v400h112Zm100 268v-456h456v456H372Z"/>
    </Icon>
  );
});
