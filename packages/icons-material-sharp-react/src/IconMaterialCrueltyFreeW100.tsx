...
const IconMaterialCrueltyFreeW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CrueltyFreeW100'
...
IconMaterialCrueltyFreeW100.displayName = 'OnesyIconMaterialCrueltyFreeW100';

export default IconMaterialCrueltyFreeW100;
