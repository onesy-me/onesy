...
const IconMaterialPersonCelebrateW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonCelebrateW100'
...
IconMaterialPersonCelebrateW100.displayName = 'OnesyIconMaterialPersonCelebrateW100';

export default IconMaterialPersonCelebrateW100;
