...
const IconMaterialAnimationW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAnimationW100.displayName = 'OnesyIconMaterialAnimationW100';

export default IconMaterialAnimationW100;
