...
const IconMaterialPartlyCloudyDayFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PartlyCloudyDayFilled'
...
IconMaterialPartlyCloudyDayFilled.displayName = 'OnesyIconMaterialPartlyCloudyDayFilled';

export default IconMaterialPartlyCloudyDayFilled;
