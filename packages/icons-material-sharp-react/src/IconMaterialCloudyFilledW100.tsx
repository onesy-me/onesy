...
const IconMaterialCloudyFilledW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledW100'
...
IconMaterialCloudyFilledW100.displayName = 'OnesyIconMaterialCloudyFilledW100';

export default IconMaterialCloudyFilledW100;
