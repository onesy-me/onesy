...
const IconMaterialWifiTetheringFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiTetheringFilled'
...
IconMaterialWifiTetheringFilled.displayName = 'OnesyIconMaterialWifiTetheringFilled';

export default IconMaterialWifiTetheringFilled;
