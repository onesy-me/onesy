...
const IconMaterialRuleSettings = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRuleSettings.displayName = 'OnesyIconMaterialRuleSettings';

export default IconMaterialRuleSettings;
