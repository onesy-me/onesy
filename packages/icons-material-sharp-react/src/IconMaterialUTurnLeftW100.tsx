...
const IconMaterialUTurnLeftW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialUTurnLeftW100.displayName = 'OnesyIconMaterialUTurnLeftW100';

export default IconMaterialUTurnLeftW100;
