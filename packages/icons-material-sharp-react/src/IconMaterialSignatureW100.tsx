...
const IconMaterialSignatureW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSignatureW100.displayName = 'OnesyIconMaterialSignatureW100';

export default IconMaterialSignatureW100;
