...
const IconMaterialDeliveryTruckSpeedFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeliveryTruckSpeedFilled'
...
IconMaterialDeliveryTruckSpeedFilled.displayName = 'OnesyIconMaterialDeliveryTruckSpeedFilled';

export default IconMaterialDeliveryTruckSpeedFilled;
