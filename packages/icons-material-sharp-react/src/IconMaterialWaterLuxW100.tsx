...
const IconMaterialWaterLuxW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWaterLuxW100.displayName = 'OnesyIconMaterialWaterLuxW100';

export default IconMaterialWaterLuxW100;
