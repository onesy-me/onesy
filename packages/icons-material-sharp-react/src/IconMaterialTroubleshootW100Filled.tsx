...
const IconMaterialTroubleshootW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TroubleshootW100Filled'
...
IconMaterialTroubleshootW100Filled.displayName = 'OnesyIconMaterialTroubleshootW100Filled';

export default IconMaterialTroubleshootW100Filled;
