...
const IconMaterialEmergencyHeat2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEmergencyHeat2.displayName = 'OnesyIconMaterialEmergencyHeat2';

export default IconMaterialEmergencyHeat2;
