...
const IconMaterialCadenceW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CadenceW100Filled'
...
IconMaterialCadenceW100Filled.displayName = 'OnesyIconMaterialCadenceW100Filled';

export default IconMaterialCadenceW100Filled;
