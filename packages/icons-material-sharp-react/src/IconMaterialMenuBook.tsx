...
const IconMaterialMenuBook = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMenuBook.displayName = 'OnesyIconMaterialMenuBook';

export default IconMaterialMenuBook;
