...
const IconMaterialMarkdownPasteW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MarkdownPasteW100Filled'
...
IconMaterialMarkdownPasteW100Filled.displayName = 'OnesyIconMaterialMarkdownPasteW100Filled';

export default IconMaterialMarkdownPasteW100Filled;
