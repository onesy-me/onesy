...
const IconMaterialFlexWrapW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlexWrapW100Filled'
...
IconMaterialFlexWrapW100Filled.displayName = 'OnesyIconMaterialFlexWrapW100Filled';

export default IconMaterialFlexWrapW100Filled;
