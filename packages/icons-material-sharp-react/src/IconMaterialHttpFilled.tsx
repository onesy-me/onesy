...
const IconMaterialHttpFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHttpFilled.displayName = 'OnesyIconMaterialHttpFilled';

export default IconMaterialHttpFilled;
