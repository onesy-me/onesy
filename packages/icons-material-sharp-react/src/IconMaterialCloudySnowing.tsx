...
const IconMaterialCloudySnowing = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudySnowing.displayName = 'OnesyIconMaterialCloudySnowing';

export default IconMaterialCloudySnowing;
