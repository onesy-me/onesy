...
const IconMaterialCloudQueueFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudQueueFilled.displayName = 'OnesyIconMaterialCloudQueueFilled';

export default IconMaterialCloudQueueFilled;
