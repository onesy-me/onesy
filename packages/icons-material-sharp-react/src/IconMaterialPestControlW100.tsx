...
const IconMaterialPestControlW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PestControlW100'
...
IconMaterialPestControlW100.displayName = 'OnesyIconMaterialPestControlW100';

export default IconMaterialPestControlW100;
