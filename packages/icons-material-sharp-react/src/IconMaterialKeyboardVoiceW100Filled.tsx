...
const IconMaterialKeyboardVoiceW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardVoiceW100Filled'
...
IconMaterialKeyboardVoiceW100Filled.displayName = 'OnesyIconMaterialKeyboardVoiceW100Filled';

export default IconMaterialKeyboardVoiceW100Filled;
