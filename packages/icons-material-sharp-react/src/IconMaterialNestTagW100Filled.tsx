...
const IconMaterialNestTagW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestTagW100Filled'
...
IconMaterialNestTagW100Filled.displayName = 'OnesyIconMaterialNestTagW100Filled';

export default IconMaterialNestTagW100Filled;
