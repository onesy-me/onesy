...
const IconMaterialFingerprintW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FingerprintW100Filled'
...
IconMaterialFingerprintW100Filled.displayName = 'OnesyIconMaterialFingerprintW100Filled';

export default IconMaterialFingerprintW100Filled;
