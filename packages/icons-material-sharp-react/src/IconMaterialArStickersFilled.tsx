...
const IconMaterialArStickersFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArStickersFilled'
...
IconMaterialArStickersFilled.displayName = 'OnesyIconMaterialArStickersFilled';

export default IconMaterialArStickersFilled;
