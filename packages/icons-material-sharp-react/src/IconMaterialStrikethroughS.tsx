...
const IconMaterialStrikethroughS = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialStrikethroughS.displayName = 'OnesyIconMaterialStrikethroughS';

export default IconMaterialStrikethroughS;
