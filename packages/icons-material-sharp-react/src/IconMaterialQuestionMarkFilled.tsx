...
const IconMaterialQuestionMarkFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialQuestionMarkFilled.displayName = 'OnesyIconMaterialQuestionMarkFilled';

export default IconMaterialQuestionMarkFilled;
