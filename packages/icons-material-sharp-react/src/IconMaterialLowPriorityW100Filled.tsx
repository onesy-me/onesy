...
const IconMaterialLowPriorityW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPriorityW100Filled'
...
IconMaterialLowPriorityW100Filled.displayName = 'OnesyIconMaterialLowPriorityW100Filled';

export default IconMaterialLowPriorityW100Filled;
