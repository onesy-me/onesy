...
const IconMaterialMatterW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMatterW100.displayName = 'OnesyIconMaterialMatterW100';

export default IconMaterialMatterW100;
