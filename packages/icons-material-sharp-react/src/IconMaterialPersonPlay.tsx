...
const IconMaterialPersonPlay = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPersonPlay.displayName = 'OnesyIconMaterialPersonPlay';

export default IconMaterialPersonPlay;
