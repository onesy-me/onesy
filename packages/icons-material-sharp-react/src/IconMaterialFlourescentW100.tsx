...
const IconMaterialFlourescentW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlourescentW100'
...
IconMaterialFlourescentW100.displayName = 'OnesyIconMaterialFlourescentW100';

export default IconMaterialFlourescentW100;
