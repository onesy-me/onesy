...
const IconMaterialAdaptiveAudioMicOffW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AdaptiveAudioMicOffW100'
