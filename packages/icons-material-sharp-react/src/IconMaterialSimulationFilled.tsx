...
const IconMaterialSimulationFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SimulationFilled'
...
IconMaterialSimulationFilled.displayName = 'OnesyIconMaterialSimulationFilled';

export default IconMaterialSimulationFilled;
