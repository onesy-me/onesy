...
const IconMaterialFrameBug = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFrameBug.displayName = 'OnesyIconMaterialFrameBug';

export default IconMaterialFrameBug;
