...
const IconMaterialBookRibbonFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BookRibbonFilled'
...
IconMaterialBookRibbonFilled.displayName = 'OnesyIconMaterialBookRibbonFilled';

export default IconMaterialBookRibbonFilled;
