...
const IconMaterialKeyboardExternalInputFilled = (props: IIcon) => {
...
IconMaterialKeyboardExternalInputFilled.displayName = 'OnesyIconMaterialKeyboardExternalInputFilled';
