...
const IconMaterialRotateRightW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RotateRightW100'
...
IconMaterialRotateRightW100.displayName = 'OnesyIconMaterialRotateRightW100';

export default IconMaterialRotateRightW100;
