...
const IconMaterialNoMealsW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNoMealsW100.displayName = 'OnesyIconMaterialNoMealsW100';

export default IconMaterialNoMealsW100;
