...
const IconMaterialResetShadow = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialResetShadow.displayName = 'OnesyIconMaterialResetShadow';

export default IconMaterialResetShadow;
