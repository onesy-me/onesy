...
const IconMaterialAttractionsFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AttractionsFilled'
...
IconMaterialAttractionsFilled.displayName = 'OnesyIconMaterialAttractionsFilled';

export default IconMaterialAttractionsFilled;
