...
const IconMaterialVoiceSelectionW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='VoiceSelectionW100Filled'
...
export default IconMaterialVoiceSelectionW100Filled;
