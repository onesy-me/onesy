...
const IconMaterialDeleteHistory = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDeleteHistory.displayName = 'OnesyIconMaterialDeleteHistory';

export default IconMaterialDeleteHistory;
