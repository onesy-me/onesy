...
const IconMaterialFarsightDigital = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFarsightDigital.displayName = 'OnesyIconMaterialFarsightDigital';

export default IconMaterialFarsightDigital;
