...
const IconMaterialNestHeatLinkEW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestHeatLinkEW100Filled'
...
IconMaterialNestHeatLinkEW100Filled.displayName = 'OnesyIconMaterialNestHeatLinkEW100Filled';

export default IconMaterialNestHeatLinkEW100Filled;
