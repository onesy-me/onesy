...
const IconMaterialCloudQueue = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudQueue.displayName = 'OnesyIconMaterialCloudQueue';

export default IconMaterialCloudQueue;
