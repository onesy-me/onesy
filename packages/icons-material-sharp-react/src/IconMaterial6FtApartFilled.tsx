...
const IconMaterial6FtApartFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterial6FtApartFilled.displayName = 'OnesyIconMaterial6FtApartFilled';

export default IconMaterial6FtApartFilled;
