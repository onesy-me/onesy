...
const IconMaterialRouterFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRouterFilled.displayName = 'OnesyIconMaterialRouterFilled';

export default IconMaterialRouterFilled;
