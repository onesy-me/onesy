...
const IconMaterialAirFreshenerW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AirFreshenerW100Filled'
...
export default IconMaterialAirFreshenerW100Filled;
