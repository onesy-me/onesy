...
const IconMaterialKeyVisualizerW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyVisualizerW100Filled'
...
IconMaterialKeyVisualizerW100Filled.displayName = 'OnesyIconMaterialKeyVisualizerW100Filled';

export default IconMaterialKeyVisualizerW100Filled;
