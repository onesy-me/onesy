...
const IconMaterialSentimentFrustratedFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentFrustratedFilled'
...
IconMaterialSentimentFrustratedFilled.displayName = 'OnesyIconMaterialSentimentFrustratedFilled';

export default IconMaterialSentimentFrustratedFilled;
