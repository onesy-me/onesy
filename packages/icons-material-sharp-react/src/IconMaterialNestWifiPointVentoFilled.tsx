...
const IconMaterialNestWifiPointVentoFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiPointVentoFilled'
...
IconMaterialNestWifiPointVentoFilled.displayName = 'OnesyIconMaterialNestWifiPointVentoFilled';

export default IconMaterialNestWifiPointVentoFilled;
