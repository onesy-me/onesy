...
const IconMaterialStrokeFullW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='StrokeFullW100Filled'
...
IconMaterialStrokeFullW100Filled.displayName = 'OnesyIconMaterialStrokeFullW100Filled';

export default IconMaterialStrokeFullW100Filled;
