...
const IconMaterialSkullFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSkullFilled.displayName = 'OnesyIconMaterialSkullFilled';

export default IconMaterialSkullFilled;
