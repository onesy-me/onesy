...
const IconMaterialSyncW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSyncW100.displayName = 'OnesyIconMaterialSyncW100';

export default IconMaterialSyncW100;
