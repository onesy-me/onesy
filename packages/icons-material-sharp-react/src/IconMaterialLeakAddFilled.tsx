...
const IconMaterialLeakAddFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLeakAddFilled.displayName = 'OnesyIconMaterialLeakAddFilled';

export default IconMaterialLeakAddFilled;
