...
const IconMaterialFrameReloadW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FrameReloadW100Filled'
...
IconMaterialFrameReloadW100Filled.displayName = 'OnesyIconMaterialFrameReloadW100Filled';

export default IconMaterialFrameReloadW100Filled;
