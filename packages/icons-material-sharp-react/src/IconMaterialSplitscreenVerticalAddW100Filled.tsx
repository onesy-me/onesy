...
const IconMaterialSplitscreenVerticalAddW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M172-172v-616h249v616H172Zm368 0v-616h248v397q-5-.5-10-.75t-10-.25q-83 0-141.5 58.29T568-192q0 5.32.5 10.16t.5 9.84h-29Zm220 92v-92h-92v-28h92v-92h28v92h92v28h-92v92h-28Z"/>
    </Icon>
  );
});
