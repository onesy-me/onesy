...
const IconMaterialSearchInsightsW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchInsightsW100Filled'
...
IconMaterialSearchInsightsW100Filled.displayName = 'OnesyIconMaterialSearchInsightsW100Filled';

export default IconMaterialSearchInsightsW100Filled;
