...
const IconMaterialTonality = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTonality.displayName = 'OnesyIconMaterialTonality';

export default IconMaterialTonality;
