...
const IconMaterialNestThermostatZirconiumEu = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestThermostatZirconiumEu.displayName = 'OnesyIconMaterialNestThermostatZirconiumEu';
