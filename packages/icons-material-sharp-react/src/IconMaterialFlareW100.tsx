...
const IconMaterialFlareW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFlareW100.displayName = 'OnesyIconMaterialFlareW100';

export default IconMaterialFlareW100;
