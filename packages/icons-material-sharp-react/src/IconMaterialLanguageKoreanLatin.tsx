...
const IconMaterialLanguageKoreanLatin = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLanguageKoreanLatin.displayName = 'OnesyIconMaterialLanguageKoreanLatin';

export default IconMaterialLanguageKoreanLatin;
