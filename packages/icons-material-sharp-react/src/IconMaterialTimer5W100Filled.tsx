...
const IconMaterialTimer5W100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='Timer5W100Filled'
...
IconMaterialTimer5W100Filled.displayName = 'OnesyIconMaterialTimer5W100Filled';

export default IconMaterialTimer5W100Filled;
