...
const IconMaterialPacemaker = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPacemaker.displayName = 'OnesyIconMaterialPacemaker';

export default IconMaterialPacemaker;
