...
const IconMaterialMagicExchangeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicExchangeFilled'
...
IconMaterialMagicExchangeFilled.displayName = 'OnesyIconMaterialMagicExchangeFilled';

export default IconMaterialMagicExchangeFilled;
