...
const IconMaterialMagicExchangeW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MagicExchangeW100'
...
IconMaterialMagicExchangeW100.displayName = 'OnesyIconMaterialMagicExchangeW100';

export default IconMaterialMagicExchangeW100;
