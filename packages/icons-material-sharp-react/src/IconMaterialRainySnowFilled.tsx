...
const IconMaterialRainySnowFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RainySnowFilled'
...
IconMaterialRainySnowFilled.displayName = 'OnesyIconMaterialRainySnowFilled';

export default IconMaterialRainySnowFilled;
