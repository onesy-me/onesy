...
const IconMaterialGlobeUkFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGlobeUkFilled.displayName = 'OnesyIconMaterialGlobeUkFilled';

export default IconMaterialGlobeUkFilled;
