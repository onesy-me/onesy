...
const IconMaterialSettingsAlert = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSettingsAlert.displayName = 'OnesyIconMaterialSettingsAlert';

export default IconMaterialSettingsAlert;
