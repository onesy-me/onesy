...
const IconMaterialDiversity1 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDiversity1.displayName = 'OnesyIconMaterialDiversity1';

export default IconMaterialDiversity1;
