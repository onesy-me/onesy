...
const IconMaterialTouchDoubleW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TouchDoubleW100'
...
IconMaterialTouchDoubleW100.displayName = 'OnesyIconMaterialTouchDoubleW100';

export default IconMaterialTouchDoubleW100;
