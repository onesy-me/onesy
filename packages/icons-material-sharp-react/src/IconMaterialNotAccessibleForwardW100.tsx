...
const IconMaterialNotAccessibleForwardW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NotAccessibleForwardW100'
...
IconMaterialNotAccessibleForwardW100.displayName = 'OnesyIconMaterialNotAccessibleForwardW100';

export default IconMaterialNotAccessibleForwardW100;
