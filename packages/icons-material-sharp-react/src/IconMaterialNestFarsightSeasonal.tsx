...
const IconMaterialNestFarsightSeasonal = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestFarsightSeasonal.displayName = 'OnesyIconMaterialNestFarsightSeasonal';

export default IconMaterialNestFarsightSeasonal;
