...
const IconMaterialPhoneInTalkWatchfaceIndicator = (props: IIcon) => {
...
IconMaterialPhoneInTalkWatchfaceIndicator.displayName = 'OnesyIconMaterialPhoneInTalkWatchfaceIndicator';
