...
const IconMaterialSportsBasketball = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSportsBasketball.displayName = 'OnesyIconMaterialSportsBasketball';

export default IconMaterialSportsBasketball;
