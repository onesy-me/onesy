...
const IconMaterialFamilyStar = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFamilyStar.displayName = 'OnesyIconMaterialFamilyStar';

export default IconMaterialFamilyStar;
