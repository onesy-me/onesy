...
const IconMaterialFolderEyeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FolderEyeFilled'
...
IconMaterialFolderEyeFilled.displayName = 'OnesyIconMaterialFolderEyeFilled';

export default IconMaterialFolderEyeFilled;
