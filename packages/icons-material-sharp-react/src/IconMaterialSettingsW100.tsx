...
const IconMaterialSettingsW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSettingsW100.displayName = 'OnesyIconMaterialSettingsW100';

export default IconMaterialSettingsW100;
