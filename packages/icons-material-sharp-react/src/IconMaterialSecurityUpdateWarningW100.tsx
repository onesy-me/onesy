...
const IconMaterialSecurityUpdateWarningW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SecurityUpdateWarningW100'
...
IconMaterialSecurityUpdateWarningW100.displayName = 'OnesyIconMaterialSecurityUpdateWarningW100';

export default IconMaterialSecurityUpdateWarningW100;
