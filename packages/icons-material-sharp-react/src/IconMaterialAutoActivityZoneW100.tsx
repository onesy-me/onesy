...
const IconMaterialAutoActivityZoneW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoActivityZoneW100'
...
IconMaterialAutoActivityZoneW100.displayName = 'OnesyIconMaterialAutoActivityZoneW100';

export default IconMaterialAutoActivityZoneW100;
