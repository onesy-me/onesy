...
const IconMaterialTargetFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTargetFilled.displayName = 'OnesyIconMaterialTargetFilled';

export default IconMaterialTargetFilled;
