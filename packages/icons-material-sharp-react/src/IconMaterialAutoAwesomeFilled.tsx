...
const IconMaterialAutoAwesomeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AutoAwesomeFilled'
...
IconMaterialAutoAwesomeFilled.displayName = 'OnesyIconMaterialAutoAwesomeFilled';

export default IconMaterialAutoAwesomeFilled;
