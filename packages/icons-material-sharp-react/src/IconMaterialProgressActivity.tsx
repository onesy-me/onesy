...
const IconMaterialProgressActivity = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialProgressActivity.displayName = 'OnesyIconMaterialProgressActivity';

export default IconMaterialProgressActivity;
