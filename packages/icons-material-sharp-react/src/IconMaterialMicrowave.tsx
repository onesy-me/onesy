...
const IconMaterialMicrowave = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMicrowave.displayName = 'OnesyIconMaterialMicrowave';

export default IconMaterialMicrowave;
