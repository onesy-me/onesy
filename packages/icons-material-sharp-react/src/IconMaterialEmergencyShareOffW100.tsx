...
const IconMaterialEmergencyShareOffW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyShareOffW100'
...
IconMaterialEmergencyShareOffW100.displayName = 'OnesyIconMaterialEmergencyShareOffW100';

export default IconMaterialEmergencyShareOffW100;
