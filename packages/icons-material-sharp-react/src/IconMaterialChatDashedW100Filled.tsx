...
const IconMaterialChatDashedW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChatDashedW100Filled'
...
IconMaterialChatDashedW100Filled.displayName = 'OnesyIconMaterialChatDashedW100Filled';

export default IconMaterialChatDashedW100Filled;
