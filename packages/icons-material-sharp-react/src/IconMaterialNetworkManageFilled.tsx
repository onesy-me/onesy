...
const IconMaterialNetworkManageFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNetworkManageFilled.displayName = 'OnesyIconMaterialNetworkManageFilled';

export default IconMaterialNetworkManageFilled;
