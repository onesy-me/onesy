...
const IconMaterialBorderTopFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BorderTopFilled'
...
IconMaterialBorderTopFilled.displayName = 'OnesyIconMaterialBorderTopFilled';

export default IconMaterialBorderTopFilled;
