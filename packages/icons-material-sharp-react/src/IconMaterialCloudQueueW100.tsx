...
const IconMaterialCloudQueueW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudQueueW100.displayName = 'OnesyIconMaterialCloudQueueW100';

export default IconMaterialCloudQueueW100;
