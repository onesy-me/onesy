...
const IconMaterialEventUpcomingW100 = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M603-132v-28h157v-368H200v154h-28v-374h140v-92h32v92h276v-92h28v92h140v616H603ZM320-37l-19-19 128-130H66v-28h363L301-344l19-19 163 163L320-37ZM200-556h560v-164H200v164Zm0 0v-164 164Z"/>
    </Icon>
  );
});
