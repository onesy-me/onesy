...
const IconMaterialCrowdsourceFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CrowdsourceFilled'

      short_name='Crowdsource'
...
IconMaterialCrowdsourceFilled.displayName = 'OnesyIconMaterialCrowdsourceFilled';

export default IconMaterialCrowdsourceFilled;
