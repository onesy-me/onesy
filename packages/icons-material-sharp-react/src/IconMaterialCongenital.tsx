...
const IconMaterialCongenital = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCongenital.displayName = 'OnesyIconMaterialCongenital';

export default IconMaterialCongenital;
