...
const IconMaterialHighlightKeyboardFocusFilled = (props: IIcon) => {
...
IconMaterialHighlightKeyboardFocusFilled.displayName = 'OnesyIconMaterialHighlightKeyboardFocusFilled';
