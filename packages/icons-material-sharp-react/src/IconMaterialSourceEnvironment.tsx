...
const IconMaterialSourceEnvironment = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSourceEnvironment.displayName = 'OnesyIconMaterialSourceEnvironment';

export default IconMaterialSourceEnvironment;
