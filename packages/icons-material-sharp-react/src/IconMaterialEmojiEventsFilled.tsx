...
const IconMaterialEmojiEventsFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEmojiEventsFilled.displayName = 'OnesyIconMaterialEmojiEventsFilled';

export default IconMaterialEmojiEventsFilled;
