...
const IconMaterialHandheldController = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHandheldController.displayName = 'OnesyIconMaterialHandheldController';

export default IconMaterialHandheldController;
