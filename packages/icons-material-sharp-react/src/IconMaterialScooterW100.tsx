...
const IconMaterialScooterW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialScooterW100.displayName = 'OnesyIconMaterialScooterW100';

export default IconMaterialScooterW100;
