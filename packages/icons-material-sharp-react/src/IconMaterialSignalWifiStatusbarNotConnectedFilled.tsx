...
const IconMaterialSignalWifiStatusbarNotConnectedFilled = (props: IIcon) => {
...
IconMaterialSignalWifiStatusbarNotConnectedFilled.displayName = 'OnesyIconMaterialSignalWifiStatusbarNotConnectedFilled';
