...
const IconMaterialGroupWorkFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGroupWorkFilled.displayName = 'OnesyIconMaterialGroupWorkFilled';

export default IconMaterialGroupWorkFilled;
