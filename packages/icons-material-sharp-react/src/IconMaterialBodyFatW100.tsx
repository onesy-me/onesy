...
const IconMaterialBodyFatW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBodyFatW100.displayName = 'OnesyIconMaterialBodyFatW100';

export default IconMaterialBodyFatW100;
