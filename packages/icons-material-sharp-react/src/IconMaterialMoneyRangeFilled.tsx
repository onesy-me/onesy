...
const IconMaterialMoneyRangeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MoneyRangeFilled'
...
IconMaterialMoneyRangeFilled.displayName = 'OnesyIconMaterialMoneyRangeFilled';

export default IconMaterialMoneyRangeFilled;
