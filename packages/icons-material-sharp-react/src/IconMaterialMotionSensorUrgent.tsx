...
const IconMaterialMotionSensorUrgent = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMotionSensorUrgent.displayName = 'OnesyIconMaterialMotionSensorUrgent';

export default IconMaterialMotionSensorUrgent;
