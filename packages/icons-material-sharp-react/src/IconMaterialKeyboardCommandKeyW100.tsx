...
const IconMaterialKeyboardCommandKeyW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardCommandKeyW100'
...
IconMaterialKeyboardCommandKeyW100.displayName = 'OnesyIconMaterialKeyboardCommandKeyW100';

export default IconMaterialKeyboardCommandKeyW100;
