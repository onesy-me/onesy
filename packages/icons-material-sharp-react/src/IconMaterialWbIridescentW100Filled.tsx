...
const IconMaterialWbIridescentW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WbIridescentW100Filled'
...
IconMaterialWbIridescentW100Filled.displayName = 'OnesyIconMaterialWbIridescentW100Filled';

export default IconMaterialWbIridescentW100Filled;
