...
const IconMaterialCarDefrostLowRightW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CarDefrostLowRightW100'
...
IconMaterialCarDefrostLowRightW100.displayName = 'OnesyIconMaterialCarDefrostLowRightW100';

export default IconMaterialCarDefrostLowRightW100;
