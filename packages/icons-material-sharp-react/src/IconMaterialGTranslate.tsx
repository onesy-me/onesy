...
const IconMaterialGTranslate = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGTranslate.displayName = 'OnesyIconMaterialGTranslate';

export default IconMaterialGTranslate;
