...
const IconMaterialGraph2Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGraph2Filled.displayName = 'OnesyIconMaterialGraph2Filled';

export default IconMaterialGraph2Filled;
