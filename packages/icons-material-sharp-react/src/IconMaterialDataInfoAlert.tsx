...
const IconMaterialDataInfoAlert = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDataInfoAlert.displayName = 'OnesyIconMaterialDataInfoAlert';

export default IconMaterialDataInfoAlert;
