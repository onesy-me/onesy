...
const IconMaterialModeFanOff = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialModeFanOff.displayName = 'OnesyIconMaterialModeFanOff';

export default IconMaterialModeFanOff;
