...
const IconMaterialSlowMotionVideoFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSlowMotionVideoFilled.displayName = 'OnesyIconMaterialSlowMotionVideoFilled';

export default IconMaterialSlowMotionVideoFilled;
