...
const IconMaterialSailingFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSailingFilled.displayName = 'OnesyIconMaterialSailingFilled';

export default IconMaterialSailingFilled;
