...
const IconMaterialIdentityPlatform = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialIdentityPlatform.displayName = 'OnesyIconMaterialIdentityPlatform';

export default IconMaterialIdentityPlatform;
