...
const IconMaterialGrid3x3OffW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGrid3x3OffW100.displayName = 'OnesyIconMaterialGrid3x3OffW100';

export default IconMaterialGrid3x3OffW100;
