...
const IconMaterialCloudyFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudyFilled.displayName = 'OnesyIconMaterialCloudyFilled';

export default IconMaterialCloudyFilled;
