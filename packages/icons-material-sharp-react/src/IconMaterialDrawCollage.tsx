...
const IconMaterialDrawCollage = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDrawCollage.displayName = 'OnesyIconMaterialDrawCollage';

export default IconMaterialDrawCollage;
