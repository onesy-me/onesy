...
const IconMaterialErrorCircleRounded = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRounded'
...
IconMaterialErrorCircleRounded.displayName = 'OnesyIconMaterialErrorCircleRounded';

export default IconMaterialErrorCircleRounded;
