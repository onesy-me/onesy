...
const IconMaterialWeatherHail = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWeatherHail.displayName = 'OnesyIconMaterialWeatherHail';

export default IconMaterialWeatherHail;
