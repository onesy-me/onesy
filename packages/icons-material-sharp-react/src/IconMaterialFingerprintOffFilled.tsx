...
const IconMaterialFingerprintOffFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FingerprintOffFilled'
...
IconMaterialFingerprintOffFilled.displayName = 'OnesyIconMaterialFingerprintOffFilled';

export default IconMaterialFingerprintOffFilled;
