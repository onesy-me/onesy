...
const IconMaterialPhotoSizeSelectSmallFilled = (props: IIcon) => {
...
IconMaterialPhotoSizeSelectSmallFilled.displayName = 'OnesyIconMaterialPhotoSizeSelectSmallFilled';
