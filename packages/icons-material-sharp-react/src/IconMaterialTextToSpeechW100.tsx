...
const IconMaterialTextToSpeechW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextToSpeechW100'
...
IconMaterialTextToSpeechW100.displayName = 'OnesyIconMaterialTextToSpeechW100';

export default IconMaterialTextToSpeechW100;
