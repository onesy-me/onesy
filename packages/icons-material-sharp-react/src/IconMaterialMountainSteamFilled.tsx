...
const IconMaterialMountainSteamFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MountainSteamFilled'
