...
const IconMaterialYoutubeActivityW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='YoutubeActivityW100'
...
IconMaterialYoutubeActivityW100.displayName = 'OnesyIconMaterialYoutubeActivityW100';

export default IconMaterialYoutubeActivityW100;
