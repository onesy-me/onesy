...
const IconMaterialMicNoiseCancelHighW100Filled = (props: IIcon) => {
...
IconMaterialMicNoiseCancelHighW100Filled.displayName = 'OnesyIconMaterialMicNoiseCancelHighW100Filled';
