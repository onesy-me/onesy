...
const IconMaterialPercentFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPercentFilled.displayName = 'OnesyIconMaterialPercentFilled';

export default IconMaterialPercentFilled;
