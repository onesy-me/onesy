...
const IconMaterialNetworkIntelligenceW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkIntelligenceW100'
...
IconMaterialNetworkIntelligenceW100.displayName = 'OnesyIconMaterialNetworkIntelligenceW100';

export default IconMaterialNetworkIntelligenceW100;
