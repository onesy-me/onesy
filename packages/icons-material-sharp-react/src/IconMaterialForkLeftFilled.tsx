...
const IconMaterialForkLeftFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialForkLeftFilled.displayName = 'OnesyIconMaterialForkLeftFilled';

export default IconMaterialForkLeftFilled;
