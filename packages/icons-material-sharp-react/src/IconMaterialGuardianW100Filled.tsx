...
const IconMaterialGuardianW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='GuardianW100Filled'
...
IconMaterialGuardianW100Filled.displayName = 'OnesyIconMaterialGuardianW100Filled';

export default IconMaterialGuardianW100Filled;
