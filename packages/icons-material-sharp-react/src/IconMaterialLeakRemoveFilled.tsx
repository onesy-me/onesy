...
const IconMaterialLeakRemoveFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLeakRemoveFilled.displayName = 'OnesyIconMaterialLeakRemoveFilled';

export default IconMaterialLeakRemoveFilled;
