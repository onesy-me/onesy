...
const IconMaterialCloudySnowingW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudySnowingW100'
...
IconMaterialCloudySnowingW100.displayName = 'OnesyIconMaterialCloudySnowingW100';

export default IconMaterialCloudySnowingW100;
