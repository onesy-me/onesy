...
const IconMaterialStrokeFull = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialStrokeFull.displayName = 'OnesyIconMaterialStrokeFull';

export default IconMaterialStrokeFull;
