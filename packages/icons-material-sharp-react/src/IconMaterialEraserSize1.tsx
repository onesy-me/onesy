...
const IconMaterialEraserSize1 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEraserSize1.displayName = 'OnesyIconMaterialEraserSize1';

export default IconMaterialEraserSize1;
