...
const IconMaterialExploreNearbyFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ExploreNearbyFilled'
...
IconMaterialExploreNearbyFilled.displayName = 'OnesyIconMaterialExploreNearbyFilled';

export default IconMaterialExploreNearbyFilled;
