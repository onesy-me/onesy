...
const IconMaterialBarcodeScannerW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BarcodeScannerW100Filled'
...
IconMaterialBarcodeScannerW100Filled.displayName = 'OnesyIconMaterialBarcodeScannerW100Filled';

export default IconMaterialBarcodeScannerW100Filled;
