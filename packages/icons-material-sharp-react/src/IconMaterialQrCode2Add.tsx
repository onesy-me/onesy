...
const IconMaterialQrCode2Add = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialQrCode2Add.displayName = 'OnesyIconMaterialQrCode2Add';

export default IconMaterialQrCode2Add;
