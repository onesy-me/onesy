...
const IconMaterialGlobeAsiaW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGlobeAsiaW100.displayName = 'OnesyIconMaterialGlobeAsiaW100';

export default IconMaterialGlobeAsiaW100;
