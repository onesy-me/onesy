...
const IconMaterialSprinkler = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSprinkler.displayName = 'OnesyIconMaterialSprinkler';

export default IconMaterialSprinkler;
