...
const IconMaterialNestLocatorTag = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestLocatorTag.displayName = 'OnesyIconMaterialNestLocatorTag';

export default IconMaterialNestLocatorTag;
