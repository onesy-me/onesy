...
const IconMaterialFlipToBackFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FlipToBackFilled'
...
IconMaterialFlipToBackFilled.displayName = 'OnesyIconMaterialFlipToBackFilled';

export default IconMaterialFlipToBackFilled;
