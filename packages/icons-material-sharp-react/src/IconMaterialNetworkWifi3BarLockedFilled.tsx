...
const IconMaterialNetworkWifi3BarLockedFilled = (props: IIcon) => {
...
IconMaterialNetworkWifi3BarLockedFilled.displayName = 'OnesyIconMaterialNetworkWifi3BarLockedFilled';
