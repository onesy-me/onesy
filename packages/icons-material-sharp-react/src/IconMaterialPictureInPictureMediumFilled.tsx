...
const IconMaterialPictureInPictureMediumFilled = (props: IIcon) => {
...
IconMaterialPictureInPictureMediumFilled.displayName = 'OnesyIconMaterialPictureInPictureMediumFilled';
