...
const IconMaterialSunnyW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SunnyW100Filled'
...
IconMaterialSunnyW100Filled.displayName = 'OnesyIconMaterialSunnyW100Filled';

export default IconMaterialSunnyW100Filled;
