...
const IconMaterialNestRemote = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestRemote.displayName = 'OnesyIconMaterialNestRemote';

export default IconMaterialNestRemote;
