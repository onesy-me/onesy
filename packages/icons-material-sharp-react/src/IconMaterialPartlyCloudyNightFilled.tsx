...
const IconMaterialPartlyCloudyNightFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PartlyCloudyNightFilled'
...
IconMaterialPartlyCloudyNightFilled.displayName = 'OnesyIconMaterialPartlyCloudyNightFilled';

export default IconMaterialPartlyCloudyNightFilled;
