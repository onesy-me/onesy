...
const IconMaterialDetectorSmoke = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDetectorSmoke.displayName = 'OnesyIconMaterialDetectorSmoke';

export default IconMaterialDetectorSmoke;
