...
const IconMaterialRestaurantMenu = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRestaurantMenu.displayName = 'OnesyIconMaterialRestaurantMenu';

export default IconMaterialRestaurantMenu;
