...
const IconMaterialJoinFullW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialJoinFullW100.displayName = 'OnesyIconMaterialJoinFullW100';

export default IconMaterialJoinFullW100;
