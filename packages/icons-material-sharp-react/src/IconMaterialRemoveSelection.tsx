...
const IconMaterialRemoveSelection = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRemoveSelection.displayName = 'OnesyIconMaterialRemoveSelection';

export default IconMaterialRemoveSelection;
