...
const IconMaterialGraph4Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGraph4Filled.displayName = 'OnesyIconMaterialGraph4Filled';

export default IconMaterialGraph4Filled;
