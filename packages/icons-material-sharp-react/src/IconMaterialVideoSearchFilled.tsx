...
const IconMaterialVideoSearchFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='VideoSearchFilled'
...
IconMaterialVideoSearchFilled.displayName = 'OnesyIconMaterialVideoSearchFilled';

export default IconMaterialVideoSearchFilled;
