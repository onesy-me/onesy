...
const IconMaterialMissingControllerFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MissingControllerFilled'
...
IconMaterialMissingControllerFilled.displayName = 'OnesyIconMaterialMissingControllerFilled';

export default IconMaterialMissingControllerFilled;
