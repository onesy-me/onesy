...
const IconMaterialWifiTetheringErrorFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiTetheringErrorFilled'
...
IconMaterialWifiTetheringErrorFilled.displayName = 'OnesyIconMaterialWifiTetheringErrorFilled';

export default IconMaterialWifiTetheringErrorFilled;
