...
const IconMaterialSettingsBackupRestore = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSettingsBackupRestore.displayName = 'OnesyIconMaterialSettingsBackupRestore';

export default IconMaterialSettingsBackupRestore;
