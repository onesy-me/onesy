...
const IconMaterialArrowUploadReadyFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowUploadReadyFilled'
...
IconMaterialArrowUploadReadyFilled.displayName = 'OnesyIconMaterialArrowUploadReadyFilled';

export default IconMaterialArrowUploadReadyFilled;
