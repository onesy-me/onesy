...
const IconMaterialMobileLandscapeW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M92-252v-460h190v-36h134v36h452v460H92Zm136.07-202q11.93 0 19.93-8.07t8-20q0-11.93-8.07-19.93t-20-8Q216-510 208-501.93t-8 20q0 11.93 8.07 19.93t20 8Z"/>
    </Icon>
  );
});
