...
const IconMaterialClockLoader40Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ClockLoader40Filled'
...
IconMaterialClockLoader40Filled.displayName = 'OnesyIconMaterialClockLoader40Filled';

export default IconMaterialClockLoader40Filled;
