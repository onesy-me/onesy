...
const IconMaterialLassoSelectW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LassoSelectW100Filled'
...
IconMaterialLassoSelectW100Filled.displayName = 'OnesyIconMaterialLassoSelectW100Filled';

export default IconMaterialLassoSelectW100Filled;
