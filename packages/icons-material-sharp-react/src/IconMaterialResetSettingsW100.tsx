...
const IconMaterialResetSettingsW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ResetSettingsW100'
...
IconMaterialResetSettingsW100.displayName = 'OnesyIconMaterialResetSettingsW100';

export default IconMaterialResetSettingsW100;
