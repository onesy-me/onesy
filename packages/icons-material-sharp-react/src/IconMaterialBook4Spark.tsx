...
const IconMaterialBook4Spark = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBook4Spark.displayName = 'OnesyIconMaterialBook4Spark';

export default IconMaterialBook4Spark;
