...
const IconMaterialSkullListW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SkullListW100Filled'
