...
const IconMaterialHourglassBottomFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHourglassBottomFilled.displayName = 'OnesyIconMaterialHourglassBottomFilled';

export default IconMaterialHourglassBottomFilled;
