...
const IconMaterialQuestionMarkW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='QuestionMarkW100'
...
IconMaterialQuestionMarkW100.displayName = 'OnesyIconMaterialQuestionMarkW100';

export default IconMaterialQuestionMarkW100;
