...
const IconMaterialStreetviewW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialStreetviewW100.displayName = 'OnesyIconMaterialStreetviewW100';

export default IconMaterialStreetviewW100;
