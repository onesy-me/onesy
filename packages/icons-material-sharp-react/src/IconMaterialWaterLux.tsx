...
const IconMaterialWaterLux = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWaterLux.displayName = 'OnesyIconMaterialWaterLux';

export default IconMaterialWaterLux;
