...
const IconMaterialCrownFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCrownFilled.displayName = 'OnesyIconMaterialCrownFilled';

export default IconMaterialCrownFilled;
