...
const IconMaterialEyeglasses2Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='Eyeglasses2Filled'
...
IconMaterialEyeglasses2Filled.displayName = 'OnesyIconMaterialEyeglasses2Filled';

export default IconMaterialEyeglasses2Filled;
