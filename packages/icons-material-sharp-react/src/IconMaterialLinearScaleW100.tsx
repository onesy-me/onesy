...
const IconMaterialLinearScaleW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LinearScaleW100'
...
IconMaterialLinearScaleW100.displayName = 'OnesyIconMaterialLinearScaleW100';

export default IconMaterialLinearScaleW100;
