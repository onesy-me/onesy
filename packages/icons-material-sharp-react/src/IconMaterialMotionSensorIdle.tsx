...
const IconMaterialMotionSensorIdle = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMotionSensorIdle.displayName = 'OnesyIconMaterialMotionSensorIdle';

export default IconMaterialMotionSensorIdle;
