...
const IconMaterialDatabaseUploadFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DatabaseUploadFilled'
...
IconMaterialDatabaseUploadFilled.displayName = 'OnesyIconMaterialDatabaseUploadFilled';

export default IconMaterialDatabaseUploadFilled;
