...
const IconMaterialStadiaControllerW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='StadiaControllerW100Filled'
