...
const IconMaterialBringYourOwnIp = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBringYourOwnIp.displayName = 'OnesyIconMaterialBringYourOwnIp';

export default IconMaterialBringYourOwnIp;
