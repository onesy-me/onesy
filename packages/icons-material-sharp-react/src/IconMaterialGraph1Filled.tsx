...
const IconMaterialGraph1Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGraph1Filled.displayName = 'OnesyIconMaterialGraph1Filled';

export default IconMaterialGraph1Filled;
