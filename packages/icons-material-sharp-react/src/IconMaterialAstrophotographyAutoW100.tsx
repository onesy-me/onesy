...
const IconMaterialAstrophotographyAutoW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyAutoW100'
