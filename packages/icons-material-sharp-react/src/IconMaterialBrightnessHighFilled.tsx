...
const IconMaterialBrightnessHighFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BrightnessHighFilled'
...
IconMaterialBrightnessHighFilled.displayName = 'OnesyIconMaterialBrightnessHighFilled';

export default IconMaterialBrightnessHighFilled;
