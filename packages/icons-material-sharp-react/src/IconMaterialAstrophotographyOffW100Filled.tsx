...
const IconMaterialAstrophotographyOffW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyOffW100Filled'
...
IconMaterialAstrophotographyOffW100Filled.displayName = 'OnesyIconMaterialAstrophotographyOffW100Filled';

export default IconMaterialAstrophotographyOffW100Filled;
