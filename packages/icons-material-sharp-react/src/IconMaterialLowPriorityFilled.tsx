...
const IconMaterialLowPriorityFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowPriorityFilled'
...
IconMaterialLowPriorityFilled.displayName = 'OnesyIconMaterialLowPriorityFilled';

export default IconMaterialLowPriorityFilled;
