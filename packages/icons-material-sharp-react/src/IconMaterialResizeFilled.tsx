...
const IconMaterialResizeFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialResizeFilled.displayName = 'OnesyIconMaterialResizeFilled';

export default IconMaterialResizeFilled;
