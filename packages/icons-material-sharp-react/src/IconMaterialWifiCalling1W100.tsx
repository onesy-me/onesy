...
const IconMaterialWifiCalling1W100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiCalling1W100'
...
IconMaterialWifiCalling1W100.displayName = 'OnesyIconMaterialWifiCalling1W100';
