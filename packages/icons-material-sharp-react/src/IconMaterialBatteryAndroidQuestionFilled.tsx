...
const IconMaterialBatteryAndroidQuestionFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAndroidQuestionFilled'
...
IconMaterialBatteryAndroidQuestionFilled.displayName = 'OnesyIconMaterialBatteryAndroidQuestionFilled';

export default IconMaterialBatteryAndroidQuestionFilled;
