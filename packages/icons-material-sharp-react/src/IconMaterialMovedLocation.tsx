...
const IconMaterialMovedLocation = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMovedLocation.displayName = 'OnesyIconMaterialMovedLocation';

export default IconMaterialMovedLocation;
