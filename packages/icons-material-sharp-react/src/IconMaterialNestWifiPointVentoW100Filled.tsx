...
const IconMaterialNestWifiPointVentoW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiPointVentoW100Filled'
...
IconMaterialNestWifiPointVentoW100Filled.displayName = 'OnesyIconMaterialNestWifiPointVentoW100Filled';

export default IconMaterialNestWifiPointVentoW100Filled;
