...
const IconMaterialDeliveryTruckSpeedW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeliveryTruckSpeedW100'
...
IconMaterialDeliveryTruckSpeedW100.displayName = 'OnesyIconMaterialDeliveryTruckSpeedW100';

export default IconMaterialDeliveryTruckSpeedW100;
