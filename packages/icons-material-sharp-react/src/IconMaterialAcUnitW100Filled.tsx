...
const IconMaterialAcUnitW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AcUnitW100Filled'
...
IconMaterialAcUnitW100Filled.displayName = 'OnesyIconMaterialAcUnitW100Filled';

export default IconMaterialAcUnitW100Filled;
