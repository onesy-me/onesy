...
const IconMaterialOpenWithW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialOpenWithW100.displayName = 'OnesyIconMaterialOpenWithW100';

export default IconMaterialOpenWithW100;
