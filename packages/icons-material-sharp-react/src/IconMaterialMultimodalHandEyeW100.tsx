...
const IconMaterialMultimodalHandEyeW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MultimodalHandEyeW100'
