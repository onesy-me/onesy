...
const IconMaterialAstrophotographyAutoFilled = (props: IIcon) => {
...
IconMaterialAstrophotographyAutoFilled.displayName = 'OnesyIconMaterialAstrophotographyAutoFilled';
