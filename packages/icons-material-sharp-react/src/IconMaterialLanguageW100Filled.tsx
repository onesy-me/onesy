...
const IconMaterialLanguageW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LanguageW100Filled'
...
IconMaterialLanguageW100Filled.displayName = 'OnesyIconMaterialLanguageW100Filled';

export default IconMaterialLanguageW100Filled;
