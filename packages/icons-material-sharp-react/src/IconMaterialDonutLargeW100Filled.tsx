...
const IconMaterialDonutLargeW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DonutLargeW100Filled'
...
IconMaterialDonutLargeW100Filled.displayName = 'OnesyIconMaterialDonutLargeW100Filled';

export default IconMaterialDonutLargeW100Filled;
