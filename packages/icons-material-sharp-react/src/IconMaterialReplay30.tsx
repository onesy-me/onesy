...
const IconMaterialReplay30 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialReplay30.displayName = 'OnesyIconMaterialReplay30';

export default IconMaterialReplay30;
