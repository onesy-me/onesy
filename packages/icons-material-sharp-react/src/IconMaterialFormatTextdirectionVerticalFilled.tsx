...
const IconMaterialFormatTextdirectionVerticalFilled = (props: IIcon) => {
...
IconMaterialFormatTextdirectionVerticalFilled.displayName = 'OnesyIconMaterialFormatTextdirectionVerticalFilled';
