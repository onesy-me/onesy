...
const IconMaterialJoinLeftW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='JoinLeftW100Filled'
...
IconMaterialJoinLeftW100Filled.displayName = 'OnesyIconMaterialJoinLeftW100Filled';

export default IconMaterialJoinLeftW100Filled;
