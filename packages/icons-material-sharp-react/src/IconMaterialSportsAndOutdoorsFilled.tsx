...
const IconMaterialSportsAndOutdoorsFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsAndOutdoorsFilled'
...
IconMaterialSportsAndOutdoorsFilled.displayName = 'OnesyIconMaterialSportsAndOutdoorsFilled';

export default IconMaterialSportsAndOutdoorsFilled;
