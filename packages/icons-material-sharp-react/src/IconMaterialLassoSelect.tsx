...
const IconMaterialLassoSelect = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLassoSelect.displayName = 'OnesyIconMaterialLassoSelect';

export default IconMaterialLassoSelect;
