...
const IconMaterialScreenRecordW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScreenRecordW100Filled'
...
IconMaterialScreenRecordW100Filled.displayName = 'OnesyIconMaterialScreenRecordW100Filled';

export default IconMaterialScreenRecordW100Filled;
