...
const IconMaterialSoundDetectionDogBarkingFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SoundDetectionDogBarkingFilled'
...
IconMaterialSoundDetectionDogBarkingFilled.displayName = 'OnesyIconMaterialSoundDetectionDogBarkingFilled';

export default IconMaterialSoundDetectionDogBarkingFilled;
