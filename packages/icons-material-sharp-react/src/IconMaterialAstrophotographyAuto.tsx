...
const IconMaterialAstrophotographyAuto = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AstrophotographyAuto'
...
IconMaterialAstrophotographyAuto.displayName = 'OnesyIconMaterialAstrophotographyAuto';

export default IconMaterialAstrophotographyAuto;
