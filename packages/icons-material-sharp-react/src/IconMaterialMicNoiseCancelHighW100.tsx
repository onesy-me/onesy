...
const IconMaterialMicNoiseCancelHighW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicNoiseCancelHighW100'
...
IconMaterialMicNoiseCancelHighW100.displayName = 'OnesyIconMaterialMicNoiseCancelHighW100';

export default IconMaterialMicNoiseCancelHighW100;
