...
const IconMaterialMotionBlurW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMotionBlurW100.displayName = 'OnesyIconMaterialMotionBlurW100';

export default IconMaterialMotionBlurW100;
