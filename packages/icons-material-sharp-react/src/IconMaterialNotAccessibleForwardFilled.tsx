...
const IconMaterialNotAccessibleForwardFilled = (props: IIcon) => {
...
IconMaterialNotAccessibleForwardFilled.displayName = 'OnesyIconMaterialNotAccessibleForwardFilled';
