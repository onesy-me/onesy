...
const IconMaterialWifiLockFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWifiLockFilled.displayName = 'OnesyIconMaterialWifiLockFilled';

export default IconMaterialWifiLockFilled;
