...
const IconMaterialZonePersonAlertW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonAlertW100Filled'
...
IconMaterialZonePersonAlertW100Filled.displayName = 'OnesyIconMaterialZonePersonAlertW100Filled';

export default IconMaterialZonePersonAlertW100Filled;
