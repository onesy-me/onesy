...
const IconMaterialFormatBoldFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatBoldFilled'
...
IconMaterialFormatBoldFilled.displayName = 'OnesyIconMaterialFormatBoldFilled';

export default IconMaterialFormatBoldFilled;
