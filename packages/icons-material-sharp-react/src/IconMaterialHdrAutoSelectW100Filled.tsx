...
const IconMaterialHdrAutoSelectW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='HdrAutoSelectW100Filled'
...
IconMaterialHdrAutoSelectW100Filled.displayName = 'OnesyIconMaterialHdrAutoSelectW100Filled';

export default IconMaterialHdrAutoSelectW100Filled;
