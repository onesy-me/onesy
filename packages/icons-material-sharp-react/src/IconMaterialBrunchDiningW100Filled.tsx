...
const IconMaterialBrunchDiningW100Filled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M132-132v-28h480v28H132Zm0-128v-28h160v-36h160v36h160v28H132Zm608 128v-250q-26-21-45-55.5T676-514v-314h152v314q0 42-17 76.5T768-382v222h60v28h-88Zm-36-488h96v-180h-96v180Z"/>
    </Icon>
  );
});
