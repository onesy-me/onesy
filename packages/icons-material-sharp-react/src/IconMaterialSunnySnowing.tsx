...
const IconMaterialSunnySnowing = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSunnySnowing.displayName = 'OnesyIconMaterialSunnySnowing';

export default IconMaterialSunnySnowing;
