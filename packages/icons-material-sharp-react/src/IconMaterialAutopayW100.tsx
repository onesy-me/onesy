...
const IconMaterialAutopayW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutopayW100.displayName = 'OnesyIconMaterialAutopayW100';

export default IconMaterialAutopayW100;
