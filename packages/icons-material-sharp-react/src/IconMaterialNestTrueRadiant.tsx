...
const IconMaterialNestTrueRadiant = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestTrueRadiant.displayName = 'OnesyIconMaterialNestTrueRadiant';

export default IconMaterialNestTrueRadiant;
