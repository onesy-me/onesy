...
const IconMaterialResetBrightnessW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ResetBrightnessW100'
...
IconMaterialResetBrightnessW100.displayName = 'OnesyIconMaterialResetBrightnessW100';

export default IconMaterialResetBrightnessW100;
