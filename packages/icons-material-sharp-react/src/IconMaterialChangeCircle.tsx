...
const IconMaterialChangeCircle = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialChangeCircle.displayName = 'OnesyIconMaterialChangeCircle';

export default IconMaterialChangeCircle;
