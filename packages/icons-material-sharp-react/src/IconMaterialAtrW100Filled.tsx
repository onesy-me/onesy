...
const IconMaterialAtrW100Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAtrW100Filled.displayName = 'OnesyIconMaterialAtrW100Filled';

export default IconMaterialAtrW100Filled;
