...
const IconMaterialAttachFileAdd = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAttachFileAdd.displayName = 'OnesyIconMaterialAttachFileAdd';

export default IconMaterialAttachFileAdd;
