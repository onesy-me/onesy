...
const IconMaterialNestThermostatW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestThermostatW100'
...
IconMaterialNestThermostatW100.displayName = 'OnesyIconMaterialNestThermostatW100';

export default IconMaterialNestThermostatW100;
