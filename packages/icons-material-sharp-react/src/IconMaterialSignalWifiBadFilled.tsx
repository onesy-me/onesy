...
const IconMaterialSignalWifiBadFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSignalWifiBadFilled.displayName = 'OnesyIconMaterialSignalWifiBadFilled';

export default IconMaterialSignalWifiBadFilled;
