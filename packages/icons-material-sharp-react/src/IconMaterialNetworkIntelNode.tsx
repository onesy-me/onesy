...
const IconMaterialNetworkIntelNode = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNetworkIntelNode.displayName = 'OnesyIconMaterialNetworkIntelNode';

export default IconMaterialNetworkIntelNode;
