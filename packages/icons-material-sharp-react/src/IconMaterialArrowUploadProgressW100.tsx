...
const IconMaterialArrowUploadProgressW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowUploadProgressW100'
...
IconMaterialArrowUploadProgressW100.displayName = 'OnesyIconMaterialArrowUploadProgressW100';

export default IconMaterialArrowUploadProgressW100;
