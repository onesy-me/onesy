...
const IconMaterialMotionSensorUrgentW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionSensorUrgentW100Filled'
...
IconMaterialMotionSensorUrgentW100Filled.displayName = 'OnesyIconMaterialMotionSensorUrgentW100Filled';

export default IconMaterialMotionSensorUrgentW100Filled;
