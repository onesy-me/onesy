...
const IconMaterial3dRotationW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterial3dRotationW100.displayName = 'OnesyIconMaterial3dRotationW100';

export default IconMaterial3dRotationW100;
