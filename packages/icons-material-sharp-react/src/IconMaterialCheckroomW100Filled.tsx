...
const IconMaterialCheckroomW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CheckroomW100Filled'
...
IconMaterialCheckroomW100Filled.displayName = 'OnesyIconMaterialCheckroomW100Filled';

export default IconMaterialCheckroomW100Filled;
