...
const IconMaterialSettingsBluetoothFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSettingsBluetoothFilled.displayName = 'OnesyIconMaterialSettingsBluetoothFilled';

export default IconMaterialSettingsBluetoothFilled;
