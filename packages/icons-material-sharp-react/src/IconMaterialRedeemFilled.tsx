...
const IconMaterialRedeemFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRedeemFilled.displayName = 'OnesyIconMaterialRedeemFilled';

export default IconMaterialRedeemFilled;
