...
const IconMaterialExplosion = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialExplosion.displayName = 'OnesyIconMaterialExplosion';

export default IconMaterialExplosion;
