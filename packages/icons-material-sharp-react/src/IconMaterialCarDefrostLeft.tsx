...
const IconMaterialCarDefrostLeft = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCarDefrostLeft.displayName = 'OnesyIconMaterialCarDefrostLeft';

export default IconMaterialCarDefrostLeft;
