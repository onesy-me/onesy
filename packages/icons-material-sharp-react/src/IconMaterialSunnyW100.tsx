...
const IconMaterialSunnyW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSunnyW100.displayName = 'OnesyIconMaterialSunnyW100';

export default IconMaterialSunnyW100;
