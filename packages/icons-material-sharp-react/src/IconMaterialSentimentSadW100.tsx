...
const IconMaterialSentimentSadW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SentimentSadW100'
...
IconMaterialSentimentSadW100.displayName = 'OnesyIconMaterialSentimentSadW100';

export default IconMaterialSentimentSadW100;
