...
const IconMaterialNetworkNodeW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkNodeW100'
...
IconMaterialNetworkNodeW100.displayName = 'OnesyIconMaterialNetworkNodeW100';

export default IconMaterialNetworkNodeW100;
