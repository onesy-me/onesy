...
const IconMaterialUrologyFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialUrologyFilled.displayName = 'OnesyIconMaterialUrologyFilled';

export default IconMaterialUrologyFilled;
