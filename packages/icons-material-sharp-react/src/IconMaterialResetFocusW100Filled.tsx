...
const IconMaterialResetFocusW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ResetFocusW100Filled'
...
IconMaterialResetFocusW100Filled.displayName = 'OnesyIconMaterialResetFocusW100Filled';

export default IconMaterialResetFocusW100Filled;
