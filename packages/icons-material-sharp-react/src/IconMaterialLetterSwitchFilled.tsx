...
const IconMaterialLetterSwitchFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LetterSwitchFilled'
...
IconMaterialLetterSwitchFilled.displayName = 'OnesyIconMaterialLetterSwitchFilled';

export default IconMaterialLetterSwitchFilled;
