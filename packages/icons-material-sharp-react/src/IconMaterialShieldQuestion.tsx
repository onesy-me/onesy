...
const IconMaterialShieldQuestion = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialShieldQuestion.displayName = 'OnesyIconMaterialShieldQuestion';

export default IconMaterialShieldQuestion;
