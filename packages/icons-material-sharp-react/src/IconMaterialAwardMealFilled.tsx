...
const IconMaterialAwardMealFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AwardMealFilled'
...
IconMaterialAwardMealFilled.displayName = 'OnesyIconMaterialAwardMealFilled';

export default IconMaterialAwardMealFilled;
