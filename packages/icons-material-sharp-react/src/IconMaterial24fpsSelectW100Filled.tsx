...
const IconMaterial24fpsSelectW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='24fpsSelectW100Filled'
...
IconMaterial24fpsSelectW100Filled.displayName = 'OnesyIconMaterial24fpsSelectW100Filled';

export default IconMaterial24fpsSelectW100Filled;
