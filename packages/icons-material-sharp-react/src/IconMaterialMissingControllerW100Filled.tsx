...
const IconMaterialMissingControllerW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MissingControllerW100Filled'
...
IconMaterialMissingControllerW100Filled.displayName = 'OnesyIconMaterialMissingControllerW100Filled';

export default IconMaterialMissingControllerW100Filled;
