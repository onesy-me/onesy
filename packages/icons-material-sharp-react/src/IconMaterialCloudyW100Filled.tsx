...
const IconMaterialCloudyW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyW100Filled'
...
IconMaterialCloudyW100Filled.displayName = 'OnesyIconMaterialCloudyW100Filled';

export default IconMaterialCloudyW100Filled;
