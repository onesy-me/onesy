...
const IconMaterialChargerW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialChargerW100.displayName = 'OnesyIconMaterialChargerW100';

export default IconMaterialChargerW100;
