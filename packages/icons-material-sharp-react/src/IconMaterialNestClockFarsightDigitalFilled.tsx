...
const IconMaterialNestClockFarsightDigitalFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestClockFarsightDigitalFilled'
...
IconMaterialNestClockFarsightDigitalFilled.displayName = 'OnesyIconMaterialNestClockFarsightDigitalFilled';

export default IconMaterialNestClockFarsightDigitalFilled;
