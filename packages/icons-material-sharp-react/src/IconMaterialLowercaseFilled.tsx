...
const IconMaterialLowercaseFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowercaseFilled'
...
IconMaterialLowercaseFilled.displayName = 'OnesyIconMaterialLowercaseFilled';

export default IconMaterialLowercaseFilled;
