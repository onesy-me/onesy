...
const IconMaterialMicAlert = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMicAlert.displayName = 'OnesyIconMaterialMicAlert';

export default IconMaterialMicAlert;
