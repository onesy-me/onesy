...
const IconMaterialNetworkIntelligenceUpdate = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNetworkIntelligenceUpdate.displayName = 'OnesyIconMaterialNetworkIntelligenceUpdate';

export default IconMaterialNetworkIntelligenceUpdate;
