...
const IconMaterialNestHeatLinkGen3 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestHeatLinkGen3.displayName = 'OnesyIconMaterialNestHeatLinkGen3';

export default IconMaterialNestHeatLinkGen3;
