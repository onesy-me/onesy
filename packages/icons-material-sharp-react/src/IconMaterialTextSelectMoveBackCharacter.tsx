...
const IconMaterialTextSelectMoveBackCharacter = (props: IIcon) => {
...
IconMaterialTextSelectMoveBackCharacter.displayName = 'OnesyIconMaterialTextSelectMoveBackCharacter';
