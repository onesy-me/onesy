...
const IconMaterialWallpaperSlideshowW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WallpaperSlideshowW100Filled'
...
IconMaterialWallpaperSlideshowW100Filled.displayName = 'OnesyIconMaterialWallpaperSlideshowW100Filled';

export default IconMaterialWallpaperSlideshowW100Filled;
