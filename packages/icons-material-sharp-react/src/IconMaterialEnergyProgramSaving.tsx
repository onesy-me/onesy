...
const IconMaterialEnergyProgramSaving = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEnergyProgramSaving.displayName = 'OnesyIconMaterialEnergyProgramSaving';

export default IconMaterialEnergyProgramSaving;
