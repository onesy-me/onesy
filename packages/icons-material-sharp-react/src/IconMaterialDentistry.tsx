...
const IconMaterialDentistry = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDentistry.displayName = 'OnesyIconMaterialDentistry';

export default IconMaterialDentistry;
