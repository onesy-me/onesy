...
const IconMaterialForward30W100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='Forward30W100Filled'
...
IconMaterialForward30W100Filled.displayName = 'OnesyIconMaterialForward30W100Filled';

export default IconMaterialForward30W100Filled;
