...
const IconMaterialSmokeFreeW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SmokeFreeW100Filled'
...
IconMaterialSmokeFreeW100Filled.displayName = 'OnesyIconMaterialSmokeFreeW100Filled';

export default IconMaterialSmokeFreeW100Filled;
