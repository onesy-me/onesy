...
const IconMaterialDatabaseSearch = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDatabaseSearch.displayName = 'OnesyIconMaterialDatabaseSearch';

export default IconMaterialDatabaseSearch;
