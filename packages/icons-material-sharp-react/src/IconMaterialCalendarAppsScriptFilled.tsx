...
const IconMaterialCalendarAppsScriptFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CalendarAppsScriptFilled'
