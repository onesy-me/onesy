...
const IconMaterialPageControlFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPageControlFilled.displayName = 'OnesyIconMaterialPageControlFilled';

export default IconMaterialPageControlFilled;
