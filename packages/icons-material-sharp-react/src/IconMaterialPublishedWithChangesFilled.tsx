...
const IconMaterialPublishedWithChangesFilled = (props: IIcon) => {
...
IconMaterialPublishedWithChangesFilled.displayName = 'OnesyIconMaterialPublishedWithChangesFilled';
