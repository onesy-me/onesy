...
const IconMaterialMoneyBagFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMoneyBagFilled.displayName = 'OnesyIconMaterialMoneyBagFilled';

export default IconMaterialMoneyBagFilled;
