...
const IconMaterialSettingsFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSettingsFilled.displayName = 'OnesyIconMaterialSettingsFilled';

export default IconMaterialSettingsFilled;
