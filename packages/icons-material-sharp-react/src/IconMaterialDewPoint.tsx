...
const IconMaterialDewPoint = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDewPoint.displayName = 'OnesyIconMaterialDewPoint';

export default IconMaterialDewPoint;
