...
const IconMaterialNestFarsightDualW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightDualW100Filled'
