...
const IconMaterialLeakRemoveW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLeakRemoveW100.displayName = 'OnesyIconMaterialLeakRemoveW100';

export default IconMaterialLeakRemoveW100;
