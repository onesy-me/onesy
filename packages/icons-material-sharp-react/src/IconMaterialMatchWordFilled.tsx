...
const IconMaterialMatchWordFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MatchWordFilled'
...
IconMaterialMatchWordFilled.displayName = 'OnesyIconMaterialMatchWordFilled';

export default IconMaterialMatchWordFilled;
