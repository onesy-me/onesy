...
const IconMaterialPersonHeart = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPersonHeart.displayName = 'OnesyIconMaterialPersonHeart';

export default IconMaterialPersonHeart;
