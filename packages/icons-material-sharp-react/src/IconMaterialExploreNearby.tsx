...
const IconMaterialExploreNearby = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialExploreNearby.displayName = 'OnesyIconMaterialExploreNearby';

export default IconMaterialExploreNearby;
