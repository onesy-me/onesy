...
const IconMaterialTextureAddW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTextureAddW100.displayName = 'OnesyIconMaterialTextureAddW100';

export default IconMaterialTextureAddW100;
