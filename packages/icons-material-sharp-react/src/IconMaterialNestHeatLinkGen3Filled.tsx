...
const IconMaterialNestHeatLinkGen3Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestHeatLinkGen3Filled'
...
IconMaterialNestHeatLinkGen3Filled.displayName = 'OnesyIconMaterialNestHeatLinkGen3Filled';

export default IconMaterialNestHeatLinkGen3Filled;
