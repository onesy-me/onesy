...
const IconMaterialResetWhiteBalanceW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ResetWhiteBalanceW100'
...
IconMaterialResetWhiteBalanceW100.displayName = 'OnesyIconMaterialResetWhiteBalanceW100';

export default IconMaterialResetWhiteBalanceW100;
