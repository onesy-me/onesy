...
const IconMaterialPregnancyW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PregnancyW100Filled'
...
IconMaterialPregnancyW100Filled.displayName = 'OnesyIconMaterialPregnancyW100Filled';

export default IconMaterialPregnancyW100Filled;
