...
const IconMaterialDeviceThermostatFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceThermostatFilled'
...
IconMaterialDeviceThermostatFilled.displayName = 'OnesyIconMaterialDeviceThermostatFilled';

export default IconMaterialDeviceThermostatFilled;
