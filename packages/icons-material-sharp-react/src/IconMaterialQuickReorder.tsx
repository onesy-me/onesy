...
const IconMaterialQuickReorder = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialQuickReorder.displayName = 'OnesyIconMaterialQuickReorder';

export default IconMaterialQuickReorder;
