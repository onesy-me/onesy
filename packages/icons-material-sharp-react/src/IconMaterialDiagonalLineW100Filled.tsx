...
const IconMaterialDiagonalLineW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DiagonalLineW100Filled'
...
IconMaterialDiagonalLineW100Filled.displayName = 'OnesyIconMaterialDiagonalLineW100Filled';

export default IconMaterialDiagonalLineW100Filled;
