...
const IconMaterialNestSecureAlarm = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestSecureAlarm.displayName = 'OnesyIconMaterialNestSecureAlarm';

export default IconMaterialNestSecureAlarm;
