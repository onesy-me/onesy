...
const IconMaterialSteppers = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSteppers.displayName = 'OnesyIconMaterialSteppers';

export default IconMaterialSteppers;
