...
const IconMaterialNetworkWifi2BarLocked = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNetworkWifi2BarLocked.displayName = 'OnesyIconMaterialNetworkWifi2BarLocked';

export default IconMaterialNetworkWifi2BarLocked;
