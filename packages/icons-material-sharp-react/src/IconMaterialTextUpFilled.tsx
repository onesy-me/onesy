...
const IconMaterialTextUpFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTextUpFilled.displayName = 'OnesyIconMaterialTextUpFilled';

export default IconMaterialTextUpFilled;
