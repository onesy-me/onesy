...
const IconMaterialBarefootW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BarefootW100Filled'
