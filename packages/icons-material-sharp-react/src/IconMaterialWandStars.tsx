...
const IconMaterialWandStars = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWandStars.displayName = 'OnesyIconMaterialWandStars';

export default IconMaterialWandStars;
