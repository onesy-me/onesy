...
const IconMaterialTatamiSeat = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTatamiSeat.displayName = 'OnesyIconMaterialTatamiSeat';

export default IconMaterialTatamiSeat;
