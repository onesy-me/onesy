...
const IconMaterialAnimationFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AnimationFilled'
...
IconMaterialAnimationFilled.displayName = 'OnesyIconMaterialAnimationFilled';

export default IconMaterialAnimationFilled;
