...
const IconMaterialMaskedTransitionsW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MaskedTransitionsW100Filled'
...
IconMaterialMaskedTransitionsW100Filled.displayName = 'OnesyIconMaterialMaskedTransitionsW100Filled';

export default IconMaterialMaskedTransitionsW100Filled;
