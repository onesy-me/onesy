...
const IconMaterialNestCamIndoorFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestCamIndoorFilled'
...
IconMaterialNestCamIndoorFilled.displayName = 'OnesyIconMaterialNestCamIndoorFilled';

export default IconMaterialNestCamIndoorFilled;
