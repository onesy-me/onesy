...
const IconMaterialOrthopedics = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialOrthopedics.displayName = 'OnesyIconMaterialOrthopedics';

export default IconMaterialOrthopedics;
