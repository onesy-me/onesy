...
<h1 align='center'>onesy Icons Material Sharp React</h1>

<p align='center'>
  Onesy Icons Material Sharp for React <br />
...
```javascript
  ...
  import IconMaterialPottedPlantSharp from '@onesy/icons-material-sharp-react/IconMaterialPottedPlant';
