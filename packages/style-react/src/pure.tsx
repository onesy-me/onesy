...
import { IResponse, pure as onesyPureMethod } from '@onesy/style';
import { IOptions } from '@onesy/style/pure';
...
export default function pure(value: TValue, options_: IOptions = {}) {
  ...
  function usePure(props_?: any) {
    ...
    const makeResponse = () => {
      ...
      response_ = onesyPureMethod(resolve(), merge(options, options_, { copy: true }));
