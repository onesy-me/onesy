...
const IconMaterialSettingsPanorama = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSettingsPanorama.displayName = 'OnesyIconMaterialSettingsPanorama';

export default IconMaterialSettingsPanorama;
