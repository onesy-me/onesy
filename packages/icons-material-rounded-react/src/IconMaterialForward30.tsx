...
const IconMaterialForward30 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialForward30.displayName = 'OnesyIconMaterialForward30';

export default IconMaterialForward30;
