...
const IconMaterialWebhookFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWebhookFilled.displayName = 'OnesyIconMaterialWebhookFilled';

export default IconMaterialWebhookFilled;
