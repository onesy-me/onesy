...
const IconMaterialDeviceResetW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DeviceResetW100Filled'
...
IconMaterialDeviceResetW100Filled.displayName = 'OnesyIconMaterialDeviceResetW100Filled';

export default IconMaterialDeviceResetW100Filled;
