...
const IconMaterialMicNoiseCancelLowFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MicNoiseCancelLowFilled'
