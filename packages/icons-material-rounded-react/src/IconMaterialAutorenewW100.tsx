...
const IconMaterialAutorenewW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutorenewW100.displayName = 'OnesyIconMaterialAutorenewW100';

export default IconMaterialAutorenewW100;
