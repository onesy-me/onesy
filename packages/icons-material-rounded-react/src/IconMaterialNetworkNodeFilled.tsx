...
const IconMaterialNetworkNodeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkNodeFilled'
...
IconMaterialNetworkNodeFilled.displayName = 'OnesyIconMaterialNetworkNodeFilled';

export default IconMaterialNetworkNodeFilled;
