...
const IconMaterialGrainFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGrainFilled.displayName = 'OnesyIconMaterialGrainFilled';

export default IconMaterialGrainFilled;
