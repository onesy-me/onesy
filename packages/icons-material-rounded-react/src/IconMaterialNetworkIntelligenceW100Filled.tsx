...
const IconMaterialNetworkIntelligenceW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkIntelligenceW100Filled'

      short_name='NetworkIntelligence'
...
IconMaterialNetworkIntelligenceW100Filled.displayName = 'OnesyIconMaterialNetworkIntelligenceW100Filled';

export default IconMaterialNetworkIntelligenceW100Filled;
