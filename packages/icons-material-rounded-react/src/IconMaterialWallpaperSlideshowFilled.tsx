...
const IconMaterialWallpaperSlideshowFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WallpaperSlideshowFilled'
...
IconMaterialWallpaperSlideshowFilled.displayName = 'OnesyIconMaterialWallpaperSlideshowFilled';

export default IconMaterialWallpaperSlideshowFilled;
