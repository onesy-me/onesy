...
const IconMaterialZonePersonIdleW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ZonePersonIdleW100Filled'
