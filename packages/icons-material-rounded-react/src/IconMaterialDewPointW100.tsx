...
const IconMaterialDewPointW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDewPointW100.displayName = 'OnesyIconMaterialDewPointW100';

export default IconMaterialDewPointW100;
