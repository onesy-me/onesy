...
const IconMaterialDriveExportFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DriveExportFilled'
...
IconMaterialDriveExportFilled.displayName = 'OnesyIconMaterialDriveExportFilled';

export default IconMaterialDriveExportFilled;
