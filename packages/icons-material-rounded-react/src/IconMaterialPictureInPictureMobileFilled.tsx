...
const IconMaterialPictureInPictureMobileFilled = (props: IIcon) => {
...
IconMaterialPictureInPictureMobileFilled.displayName = 'OnesyIconMaterialPictureInPictureMobileFilled';
