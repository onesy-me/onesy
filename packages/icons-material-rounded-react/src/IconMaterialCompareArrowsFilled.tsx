...
const IconMaterialCompareArrowsFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCompareArrowsFilled.displayName = 'OnesyIconMaterialCompareArrowsFilled';

export default IconMaterialCompareArrowsFilled;
