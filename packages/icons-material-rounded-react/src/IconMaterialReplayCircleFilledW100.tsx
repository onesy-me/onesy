...
const IconMaterialReplayCircleFilledW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplayCircleFilledW100'
...
IconMaterialReplayCircleFilledW100.displayName = 'OnesyIconMaterialReplayCircleFilledW100';

export default IconMaterialReplayCircleFilledW100;
