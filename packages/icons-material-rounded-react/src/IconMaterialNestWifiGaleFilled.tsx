...
const IconMaterialNestWifiGaleFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiGaleFilled'
...
IconMaterialNestWifiGaleFilled.displayName = 'OnesyIconMaterialNestWifiGaleFilled';

export default IconMaterialNestWifiGaleFilled;
