...
const IconMaterialModeOffOnW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ModeOffOnW100Filled'
...
IconMaterialModeOffOnW100Filled.displayName = 'OnesyIconMaterialModeOffOnW100Filled';

export default IconMaterialModeOffOnW100Filled;
