...
const IconMaterialHistory2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHistory2.displayName = 'OnesyIconMaterialHistory2';

export default IconMaterialHistory2;
