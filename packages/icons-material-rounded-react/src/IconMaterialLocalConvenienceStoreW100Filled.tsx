...
const IconMaterialLocalConvenienceStoreW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalConvenienceStoreW100Filled'
...
IconMaterialLocalConvenienceStoreW100Filled.displayName = 'OnesyIconMaterialLocalConvenienceStoreW100Filled';

export default IconMaterialLocalConvenienceStoreW100Filled;
