...
const IconMaterialNestWifiPoint = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestWifiPoint.displayName = 'OnesyIconMaterialNestWifiPoint';

export default IconMaterialNestWifiPoint;
