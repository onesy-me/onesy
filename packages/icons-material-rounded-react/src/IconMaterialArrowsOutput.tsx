...
const IconMaterialArrowsOutput = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialArrowsOutput.displayName = 'OnesyIconMaterialArrowsOutput';

export default IconMaterialArrowsOutput;
