...
const IconMaterialManufacturingW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ManufacturingW100Filled'
