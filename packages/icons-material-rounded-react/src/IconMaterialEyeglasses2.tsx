...
const IconMaterialEyeglasses2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEyeglasses2.displayName = 'OnesyIconMaterialEyeglasses2';

export default IconMaterialEyeglasses2;
