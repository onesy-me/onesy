...
const IconMaterialLinkOffFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLinkOffFilled.displayName = 'OnesyIconMaterialLinkOffFilled';

export default IconMaterialLinkOffFilled;
