...
const IconMaterialSentimentVerySatisfiedFilled = (props: IIcon) => {
...
IconMaterialSentimentVerySatisfiedFilled.displayName = 'OnesyIconMaterialSentimentVerySatisfiedFilled';
