...
const IconMaterialOutputCircle = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialOutputCircle.displayName = 'OnesyIconMaterialOutputCircle';

export default IconMaterialOutputCircle;
