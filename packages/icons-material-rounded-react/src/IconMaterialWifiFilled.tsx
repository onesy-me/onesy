...
const IconMaterialWifiFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWifiFilled.displayName = 'OnesyIconMaterialWifiFilled';

export default IconMaterialWifiFilled;
