...
const IconMaterialStylusLaserPointerW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='StylusLaserPointerW100'
...
IconMaterialStylusLaserPointerW100.displayName = 'OnesyIconMaterialStylusLaserPointerW100';

export default IconMaterialStylusLaserPointerW100;
