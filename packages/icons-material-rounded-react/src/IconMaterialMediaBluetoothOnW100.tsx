...
const IconMaterialMediaBluetoothOnW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MediaBluetoothOnW100'
...
IconMaterialMediaBluetoothOnW100.displayName = 'OnesyIconMaterialMediaBluetoothOnW100';

export default IconMaterialMediaBluetoothOnW100;
