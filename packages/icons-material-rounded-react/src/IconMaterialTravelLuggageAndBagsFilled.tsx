...
const IconMaterialTravelLuggageAndBagsFilled = (props: IIcon) => {
...
IconMaterialTravelLuggageAndBagsFilled.displayName = 'OnesyIconMaterialTravelLuggageAndBagsFilled';
