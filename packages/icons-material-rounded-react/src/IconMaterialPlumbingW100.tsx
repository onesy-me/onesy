...
const IconMaterialPlumbingW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPlumbingW100.displayName = 'OnesyIconMaterialPlumbingW100';

export default IconMaterialPlumbingW100;
