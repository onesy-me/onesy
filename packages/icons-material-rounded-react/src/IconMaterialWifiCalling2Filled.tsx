...
const IconMaterialWifiCalling2Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiCalling2Filled'
...
IconMaterialWifiCalling2Filled.displayName = 'OnesyIconMaterialWifiCalling2Filled';

export default IconMaterialWifiCalling2Filled;
