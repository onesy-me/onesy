...
const IconMaterialBreastfeeding = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBreastfeeding.displayName = 'OnesyIconMaterialBreastfeeding';

export default IconMaterialBreastfeeding;
