...
const IconMaterialLabResearch = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLabResearch.displayName = 'OnesyIconMaterialLabResearch';

export default IconMaterialLabResearch;
