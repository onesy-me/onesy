...
const IconMaterialMergeTypeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MergeTypeFilled'
...
IconMaterialMergeTypeFilled.displayName = 'OnesyIconMaterialMergeTypeFilled';

export default IconMaterialMergeTypeFilled;
