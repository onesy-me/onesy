...
const IconMaterialDirectionsRailway2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDirectionsRailway2.displayName = 'OnesyIconMaterialDirectionsRailway2';

export default IconMaterialDirectionsRailway2;
