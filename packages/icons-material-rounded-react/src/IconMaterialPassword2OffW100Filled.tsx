...
const IconMaterialPassword2OffW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='Password2OffW100Filled'
...
IconMaterialPassword2OffW100Filled.displayName = 'OnesyIconMaterialPassword2OffW100Filled';

export default IconMaterialPassword2OffW100Filled;
