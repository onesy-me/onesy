...
const IconMaterialListFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialListFilled.displayName = 'OnesyIconMaterialListFilled';

export default IconMaterialListFilled;
