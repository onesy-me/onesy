...
const IconMaterialContrastCircleFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContrastCircleFilled'
...
IconMaterialContrastCircleFilled.displayName = 'OnesyIconMaterialContrastCircleFilled';

export default IconMaterialContrastCircleFilled;
