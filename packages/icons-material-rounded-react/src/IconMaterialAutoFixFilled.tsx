...
const IconMaterialAutoFixFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutoFixFilled.displayName = 'OnesyIconMaterialAutoFixFilled';

export default IconMaterialAutoFixFilled;
