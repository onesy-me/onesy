...
const IconMaterialGenetics = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGenetics.displayName = 'OnesyIconMaterialGenetics';

export default IconMaterialGenetics;
