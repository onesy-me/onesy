...
const IconMaterialSportsAndOutdoors = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSportsAndOutdoors.displayName = 'OnesyIconMaterialSportsAndOutdoors';

export default IconMaterialSportsAndOutdoors;
