...
const IconMaterialCallMergeFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCallMergeFilled.displayName = 'OnesyIconMaterialCallMergeFilled';

export default IconMaterialCallMergeFilled;
