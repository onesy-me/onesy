...
const IconMaterialNestThermostat = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestThermostat.displayName = 'OnesyIconMaterialNestThermostat';

export default IconMaterialNestThermostat;
