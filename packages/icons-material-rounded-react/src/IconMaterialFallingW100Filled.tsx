...
const IconMaterialFallingW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FallingW100Filled'
...
IconMaterialFallingW100Filled.displayName = 'OnesyIconMaterialFallingW100Filled';

export default IconMaterialFallingW100Filled;
