...
const IconMaterialFolderCheck2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFolderCheck2.displayName = 'OnesyIconMaterialFolderCheck2';

export default IconMaterialFolderCheck2;
