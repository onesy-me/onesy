...
const IconMaterialWebAssetOffFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WebAssetOffFilled'
...
IconMaterialWebAssetOffFilled.displayName = 'OnesyIconMaterialWebAssetOffFilled';

export default IconMaterialWebAssetOffFilled;
