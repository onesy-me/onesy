...
const IconMaterialCloudyFilledW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledW100Filled'
...
IconMaterialCloudyFilledW100Filled.displayName = 'OnesyIconMaterialCloudyFilledW100Filled';

export default IconMaterialCloudyFilledW100Filled;
