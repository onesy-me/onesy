...
const IconMaterialBrightness1Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBrightness1Filled.displayName = 'OnesyIconMaterialBrightness1Filled';

export default IconMaterialBrightness1Filled;
