...
const IconMaterialFilterArrowRightFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterArrowRightFilled'
...
IconMaterialFilterArrowRightFilled.displayName = 'OnesyIconMaterialFilterArrowRightFilled';

export default IconMaterialFilterArrowRightFilled;
