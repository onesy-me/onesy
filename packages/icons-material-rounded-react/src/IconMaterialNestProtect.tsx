...
const IconMaterialNestProtect = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestProtect.displayName = 'OnesyIconMaterialNestProtect';

export default IconMaterialNestProtect;
