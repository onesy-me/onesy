...
const IconMaterialGooglePlusReshareW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='GooglePlusReshareW100Filled'
...
IconMaterialGooglePlusReshareW100Filled.displayName = 'OnesyIconMaterialGooglePlusReshareW100Filled';

export default IconMaterialGooglePlusReshareW100Filled;
