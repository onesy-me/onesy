...
const IconMaterialCloudLock = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCloudLock.displayName = 'OnesyIconMaterialCloudLock';

export default IconMaterialCloudLock;
