...
const IconMaterialSportsSoccerFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SportsSoccerFilled'
...
IconMaterialSportsSoccerFilled.displayName = 'OnesyIconMaterialSportsSoccerFilled';

export default IconMaterialSportsSoccerFilled;
