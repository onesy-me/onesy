...
const IconMaterialSearchActivityFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchActivityFilled'

      short_name='SearchActivity'
...
IconMaterialSearchActivityFilled.displayName = 'OnesyIconMaterialSearchActivityFilled';

export default IconMaterialSearchActivityFilled;
