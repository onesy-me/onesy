...
const IconMaterialBatteryAndroidFramePlusFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAndroidFramePlusFilled'
...
IconMaterialBatteryAndroidFramePlusFilled.displayName = 'OnesyIconMaterialBatteryAndroidFramePlusFilled';

export default IconMaterialBatteryAndroidFramePlusFilled;
