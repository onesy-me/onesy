...
const IconMaterialLaptopCar = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLaptopCar.displayName = 'OnesyIconMaterialLaptopCar';

export default IconMaterialLaptopCar;
