...
const IconMaterialResetShutterSpeed = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialResetShutterSpeed.displayName = 'OnesyIconMaterialResetShutterSpeed';

export default IconMaterialResetShutterSpeed;
