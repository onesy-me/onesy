...
const IconMaterialEarSound = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEarSound.displayName = 'OnesyIconMaterialEarSound';

export default IconMaterialEarSound;
