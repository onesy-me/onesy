...
const IconMaterialNoAdultContentW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoAdultContentW100'
...
IconMaterialNoAdultContentW100.displayName = 'OnesyIconMaterialNoAdultContentW100';

export default IconMaterialNoAdultContentW100;
