...
const IconMaterialNestMiniFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestMiniFilled.displayName = 'OnesyIconMaterialNestMiniFilled';

export default IconMaterialNestMiniFilled;
