...
const IconMaterialHumidityIndoor = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHumidityIndoor.displayName = 'OnesyIconMaterialHumidityIndoor';

export default IconMaterialHumidityIndoor;
