...
const IconMaterialMotionMode = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMotionMode.displayName = 'OnesyIconMaterialMotionMode';

export default IconMaterialMotionMode;
