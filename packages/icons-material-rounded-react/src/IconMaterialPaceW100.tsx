...
const IconMaterialPaceW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPaceW100.displayName = 'OnesyIconMaterialPaceW100';

export default IconMaterialPaceW100;
