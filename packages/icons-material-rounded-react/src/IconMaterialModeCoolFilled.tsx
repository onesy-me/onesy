...
const IconMaterialModeCoolFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialModeCoolFilled.displayName = 'OnesyIconMaterialModeCoolFilled';

export default IconMaterialModeCoolFilled;
