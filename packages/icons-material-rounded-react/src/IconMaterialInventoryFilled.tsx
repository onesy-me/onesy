...
const IconMaterialInventoryFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialInventoryFilled.displayName = 'OnesyIconMaterialInventoryFilled';

export default IconMaterialInventoryFilled;
