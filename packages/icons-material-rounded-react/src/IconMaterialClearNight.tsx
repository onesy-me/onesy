...
const IconMaterialClearNight = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialClearNight.displayName = 'OnesyIconMaterialClearNight';

export default IconMaterialClearNight;
