...
const IconMaterialWindshieldDefrostFrontFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WindshieldDefrostFrontFilled'
