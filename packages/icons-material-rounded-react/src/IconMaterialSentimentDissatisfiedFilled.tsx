...
const IconMaterialSentimentDissatisfiedFilled = (props: IIcon) => {
...
IconMaterialSentimentDissatisfiedFilled.displayName = 'OnesyIconMaterialSentimentDissatisfiedFilled';
