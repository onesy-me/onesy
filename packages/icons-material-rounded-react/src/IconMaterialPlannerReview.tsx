...
const IconMaterialPlannerReview = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPlannerReview.displayName = 'OnesyIconMaterialPlannerReview';

export default IconMaterialPlannerReview;
