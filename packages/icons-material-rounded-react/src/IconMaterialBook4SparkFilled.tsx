...
const IconMaterialBook4SparkFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='Book4SparkFilled'
...
IconMaterialBook4SparkFilled.displayName = 'OnesyIconMaterialBook4SparkFilled';

export default IconMaterialBook4SparkFilled;
