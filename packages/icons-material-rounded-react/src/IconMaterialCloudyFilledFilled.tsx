...
const IconMaterialCloudyFilledFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CloudyFilledFilled'
...
IconMaterialCloudyFilledFilled.displayName = 'OnesyIconMaterialCloudyFilledFilled';

export default IconMaterialCloudyFilledFilled;
