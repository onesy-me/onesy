...
const IconMaterialFootprint = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFootprint.displayName = 'OnesyIconMaterialFootprint';

export default IconMaterialFootprint;
