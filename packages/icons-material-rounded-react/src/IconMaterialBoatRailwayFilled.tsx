...
const IconMaterialBoatRailwayFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BoatRailwayFilled'
...
IconMaterialBoatRailwayFilled.displayName = 'OnesyIconMaterialBoatRailwayFilled';

export default IconMaterialBoatRailwayFilled;
