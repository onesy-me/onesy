...
const IconMaterialBrightness2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBrightness2.displayName = 'OnesyIconMaterialBrightness2';

export default IconMaterialBrightness2;
