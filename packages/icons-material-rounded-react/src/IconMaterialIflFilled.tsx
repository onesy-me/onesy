...
const IconMaterialIflFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialIflFilled.displayName = 'OnesyIconMaterialIflFilled';

export default IconMaterialIflFilled;
