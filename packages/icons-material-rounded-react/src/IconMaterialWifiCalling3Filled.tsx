...
const IconMaterialWifiCalling3Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWifiCalling3Filled.displayName = 'OnesyIconMaterialWifiCalling3Filled';

export default IconMaterialWifiCalling3Filled;
