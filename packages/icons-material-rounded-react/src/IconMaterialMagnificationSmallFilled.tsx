...
const IconMaterialMagnificationSmallFilled = React.forwardRef((props: IIcon, ref) => {
  ...
  return (
    <Icon
      ...
      {...props}
    >
      <path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm120-360q33 0 56.5-23.5T360-600q0-33-23.5-56.5T280-680q-33 0-56.5 23.5T200-600q0 33 23.5 56.5T280-520Z"/>
    </Icon>
  );
});
