...
const IconMaterialAtrFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAtrFilled.displayName = 'OnesyIconMaterialAtrFilled';

export default IconMaterialAtrFilled;
