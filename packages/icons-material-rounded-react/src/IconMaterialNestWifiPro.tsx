...
const IconMaterialNestWifiPro = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestWifiPro.displayName = 'OnesyIconMaterialNestWifiPro';

export default IconMaterialNestWifiPro;
