...
const IconMaterialNestFarsightHeatW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightHeatW100Filled'
...
IconMaterialNestFarsightHeatW100Filled.displayName = 'OnesyIconMaterialNestFarsightHeatW100Filled';

export default IconMaterialNestFarsightHeatW100Filled;
