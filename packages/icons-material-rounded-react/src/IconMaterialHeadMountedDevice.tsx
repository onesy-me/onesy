...
const IconMaterialHeadMountedDevice = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHeadMountedDevice.displayName = 'OnesyIconMaterialHeadMountedDevice';

export default IconMaterialHeadMountedDevice;
