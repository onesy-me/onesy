...
const IconMaterialHistoryOffW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHistoryOffW100.displayName = 'OnesyIconMaterialHistoryOffW100';

export default IconMaterialHistoryOffW100;
