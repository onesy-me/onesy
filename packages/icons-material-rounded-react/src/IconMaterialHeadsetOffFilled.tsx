...
const IconMaterialHeadsetOffFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHeadsetOffFilled.displayName = 'OnesyIconMaterialHeadsetOffFilled';

export default IconMaterialHeadsetOffFilled;
