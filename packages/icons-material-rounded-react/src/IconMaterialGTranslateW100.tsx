...
const IconMaterialGTranslateW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGTranslateW100.displayName = 'OnesyIconMaterialGTranslateW100';

export default IconMaterialGTranslateW100;
