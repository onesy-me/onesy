...
const IconMaterialCommunitiesFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCommunitiesFilled.displayName = 'OnesyIconMaterialCommunitiesFilled';

export default IconMaterialCommunitiesFilled;
