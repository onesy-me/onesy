...
const IconMaterialNetworkIntelNodeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkIntelNodeFilled'
...
IconMaterialNetworkIntelNodeFilled.displayName = 'OnesyIconMaterialNetworkIntelNodeFilled';

export default IconMaterialNetworkIntelNodeFilled;
