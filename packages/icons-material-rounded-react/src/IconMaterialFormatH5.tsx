...
const IconMaterialFormatH5 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFormatH5.displayName = 'OnesyIconMaterialFormatH5';

export default IconMaterialFormatH5;
