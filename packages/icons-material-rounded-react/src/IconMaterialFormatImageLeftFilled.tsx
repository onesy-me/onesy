...
const IconMaterialFormatImageLeftFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FormatImageLeftFilled'
...
IconMaterialFormatImageLeftFilled.displayName = 'OnesyIconMaterialFormatImageLeftFilled';

export default IconMaterialFormatImageLeftFilled;
