...
const IconMaterialSplitscreenVerticalAddFilled = (props: IIcon) => {
...
IconMaterialSplitscreenVerticalAddFilled.displayName = 'OnesyIconMaterialSplitscreenVerticalAddFilled';
