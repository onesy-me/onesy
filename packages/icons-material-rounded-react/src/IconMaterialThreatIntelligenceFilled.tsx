...
const IconMaterialThreatIntelligenceFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThreatIntelligenceFilled'
...
IconMaterialThreatIntelligenceFilled.displayName = 'OnesyIconMaterialThreatIntelligenceFilled';

export default IconMaterialThreatIntelligenceFilled;
