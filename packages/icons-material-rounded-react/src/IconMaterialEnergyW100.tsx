...
const IconMaterialEnergyW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEnergyW100.displayName = 'OnesyIconMaterialEnergyW100';

export default IconMaterialEnergyW100;
