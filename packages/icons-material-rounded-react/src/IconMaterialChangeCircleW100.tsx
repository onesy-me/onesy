...
const IconMaterialChangeCircleW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChangeCircleW100'
...
IconMaterialChangeCircleW100.displayName = 'OnesyIconMaterialChangeCircleW100';

export default IconMaterialChangeCircleW100;
