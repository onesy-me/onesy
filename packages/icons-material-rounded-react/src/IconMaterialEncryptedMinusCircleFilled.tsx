...
const IconMaterialEncryptedMinusCircleFilled = (props: IIcon) => {
...
IconMaterialEncryptedMinusCircleFilled.displayName = 'OnesyIconMaterialEncryptedMinusCircleFilled';
