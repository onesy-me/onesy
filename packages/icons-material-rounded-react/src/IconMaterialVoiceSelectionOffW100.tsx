...
const IconMaterialVoiceSelectionOffW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='VoiceSelectionOffW100'
...
IconMaterialVoiceSelectionOffW100.displayName = 'OnesyIconMaterialVoiceSelectionOffW100';

export default IconMaterialVoiceSelectionOffW100;
