...
const IconMaterialBatteryVeryLow = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBatteryVeryLow.displayName = 'OnesyIconMaterialBatteryVeryLow';

export default IconMaterialBatteryVeryLow;
