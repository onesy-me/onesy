...
const IconMaterialTwoWheelerFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TwoWheelerFilled'
...
IconMaterialTwoWheelerFilled.displayName = 'OnesyIconMaterialTwoWheelerFilled';

export default IconMaterialTwoWheelerFilled;
