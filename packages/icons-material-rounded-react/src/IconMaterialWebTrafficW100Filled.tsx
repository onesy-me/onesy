...
const IconMaterialWebTrafficW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WebTrafficW100Filled'
...
IconMaterialWebTrafficW100Filled.displayName = 'OnesyIconMaterialWebTrafficW100Filled';

export default IconMaterialWebTrafficW100Filled;
