...
const IconMaterialSteppersW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSteppersW100.displayName = 'OnesyIconMaterialSteppersW100';

export default IconMaterialSteppersW100;
