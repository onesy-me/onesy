...
const IconMaterialDesktopCloud = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDesktopCloud.displayName = 'OnesyIconMaterialDesktopCloud';

export default IconMaterialDesktopCloud;
