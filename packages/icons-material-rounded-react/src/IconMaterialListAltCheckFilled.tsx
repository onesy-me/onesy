...
const IconMaterialListAltCheckFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ListAltCheckFilled'
...
IconMaterialListAltCheckFilled.displayName = 'OnesyIconMaterialListAltCheckFilled';

export default IconMaterialListAltCheckFilled;
