...
const IconMaterialScreenRecordFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ScreenRecordFilled'
...
IconMaterialScreenRecordFilled.displayName = 'OnesyIconMaterialScreenRecordFilled';

export default IconMaterialScreenRecordFilled;
