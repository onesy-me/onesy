...
const IconMaterialMotionModeW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionModeW100Filled'
...
IconMaterialMotionModeW100Filled.displayName = 'OnesyIconMaterialMotionModeW100Filled';

export default IconMaterialMotionModeW100Filled;
