...
const IconMaterialPartnerHeart = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPartnerHeart.displayName = 'OnesyIconMaterialPartnerHeart';

export default IconMaterialPartnerHeart;
