...
const IconMaterialCustomTypographyFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CustomTypographyFilled'
...
IconMaterialCustomTypographyFilled.displayName = 'OnesyIconMaterialCustomTypographyFilled';

export default IconMaterialCustomTypographyFilled;
