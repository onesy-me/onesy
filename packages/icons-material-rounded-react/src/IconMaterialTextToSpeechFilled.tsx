...
const IconMaterialTextToSpeechFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextToSpeechFilled'
...
IconMaterialTextToSpeechFilled.displayName = 'OnesyIconMaterialTextToSpeechFilled';

export default IconMaterialTextToSpeechFilled;
