...
const IconMaterialForward10 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialForward10.displayName = 'OnesyIconMaterialForward10';

export default IconMaterialForward10;
