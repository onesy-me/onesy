...
const IconMaterialAttachMoney = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAttachMoney.displayName = 'OnesyIconMaterialAttachMoney';

export default IconMaterialAttachMoney;
