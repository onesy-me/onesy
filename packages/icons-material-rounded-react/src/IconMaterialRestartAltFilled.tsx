...
const IconMaterialRestartAltFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RestartAltFilled'
...
IconMaterialRestartAltFilled.displayName = 'OnesyIconMaterialRestartAltFilled';

export default IconMaterialRestartAltFilled;
