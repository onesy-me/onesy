...
const IconMaterialConversionPathW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConversionPathW100Filled'
...
IconMaterialConversionPathW100Filled.displayName = 'OnesyIconMaterialConversionPathW100Filled';

export default IconMaterialConversionPathW100Filled;
