...
const IconMaterialNestFarsightCool = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestFarsightCool.displayName = 'OnesyIconMaterialNestFarsightCool';

export default IconMaterialNestFarsightCool;
