...
const IconMaterialBarefoot = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBarefoot.displayName = 'OnesyIconMaterialBarefoot';

export default IconMaterialBarefoot;
