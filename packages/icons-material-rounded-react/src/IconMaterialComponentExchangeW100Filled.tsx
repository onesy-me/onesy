...
const IconMaterialComponentExchangeW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ComponentExchangeW100Filled'
