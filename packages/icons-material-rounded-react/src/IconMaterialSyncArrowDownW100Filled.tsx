...
const IconMaterialSyncArrowDownW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SyncArrowDownW100Filled'
...
IconMaterialSyncArrowDownW100Filled.displayName = 'OnesyIconMaterialSyncArrowDownW100Filled';

export default IconMaterialSyncArrowDownW100Filled;
