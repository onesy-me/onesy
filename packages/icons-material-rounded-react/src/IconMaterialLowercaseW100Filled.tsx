...
const IconMaterialLowercaseW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LowercaseW100Filled'
...
IconMaterialLowercaseW100Filled.displayName = 'OnesyIconMaterialLowercaseW100Filled';

export default IconMaterialLowercaseW100Filled;
