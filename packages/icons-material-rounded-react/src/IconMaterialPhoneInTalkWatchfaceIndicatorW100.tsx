...
const IconMaterialPhoneInTalkWatchfaceIndicatorW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PhoneInTalkWatchfaceIndicatorW100'
