...
const IconMaterialNestWifiPointVentoW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiPointVentoW100'
