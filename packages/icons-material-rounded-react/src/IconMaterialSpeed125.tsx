...
const IconMaterialSpeed125 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSpeed125.displayName = 'OnesyIconMaterialSpeed125';

export default IconMaterialSpeed125;
