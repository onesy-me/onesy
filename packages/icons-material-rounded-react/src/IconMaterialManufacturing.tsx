...
const IconMaterialManufacturing = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialManufacturing.displayName = 'OnesyIconMaterialManufacturing';

export default IconMaterialManufacturing;
