...
const IconMaterialBottomRightClick = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBottomRightClick.displayName = 'OnesyIconMaterialBottomRightClick';

export default IconMaterialBottomRightClick;
