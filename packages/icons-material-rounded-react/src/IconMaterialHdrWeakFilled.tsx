...
const IconMaterialHdrWeakFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHdrWeakFilled.displayName = 'OnesyIconMaterialHdrWeakFilled';

export default IconMaterialHdrWeakFilled;
