...
const IconMaterialPowerSettingsCircleFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PowerSettingsCircleFilled'
...
IconMaterialPowerSettingsCircleFilled.displayName = 'OnesyIconMaterialPowerSettingsCircleFilled';

export default IconMaterialPowerSettingsCircleFilled;
