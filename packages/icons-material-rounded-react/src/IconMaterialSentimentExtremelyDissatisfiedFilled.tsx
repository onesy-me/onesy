...
const IconMaterialSentimentExtremelyDissatisfiedFilled = (props: IIcon) => {
...
IconMaterialSentimentExtremelyDissatisfiedFilled.displayName = 'OnesyIconMaterialSentimentExtremelyDissatisfiedFilled';
