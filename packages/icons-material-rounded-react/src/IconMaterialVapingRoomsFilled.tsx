...
const IconMaterialVapingRoomsFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='VapingRoomsFilled'
...
IconMaterialVapingRoomsFilled.displayName = 'OnesyIconMaterialVapingRoomsFilled';

export default IconMaterialVapingRoomsFilled;
