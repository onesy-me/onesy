...
const IconMaterialResetSettings = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialResetSettings.displayName = 'OnesyIconMaterialResetSettings';

export default IconMaterialResetSettings;
