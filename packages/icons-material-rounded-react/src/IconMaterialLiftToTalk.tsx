...
const IconMaterialLiftToTalk = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialLiftToTalk.displayName = 'OnesyIconMaterialLiftToTalk';

export default IconMaterialLiftToTalk;
