...
const IconMaterialActivityZoneFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialActivityZoneFilled.displayName = 'OnesyIconMaterialActivityZoneFilled';

export default IconMaterialActivityZoneFilled;
