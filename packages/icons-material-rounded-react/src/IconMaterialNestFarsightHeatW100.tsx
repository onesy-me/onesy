...
const IconMaterialNestFarsightHeatW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightHeatW100'
...
IconMaterialNestFarsightHeatW100.displayName = 'OnesyIconMaterialNestFarsightHeatW100';

export default IconMaterialNestFarsightHeatW100;
