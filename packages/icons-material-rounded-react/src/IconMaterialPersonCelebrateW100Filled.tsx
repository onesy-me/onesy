...
const IconMaterialPersonCelebrateW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PersonCelebrateW100Filled'
