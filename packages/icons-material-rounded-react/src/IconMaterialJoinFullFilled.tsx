...
const IconMaterialJoinFullFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialJoinFullFilled.displayName = 'OnesyIconMaterialJoinFullFilled';

export default IconMaterialJoinFullFilled;
