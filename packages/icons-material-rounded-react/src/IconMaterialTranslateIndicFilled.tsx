...
const IconMaterialTranslateIndicFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TranslateIndicFilled'
