...
const IconMaterialFootprintFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FootprintFilled'
...
IconMaterialFootprintFilled.displayName = 'OnesyIconMaterialFootprintFilled';

export default IconMaterialFootprintFilled;
