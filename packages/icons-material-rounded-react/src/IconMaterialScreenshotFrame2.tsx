...
const IconMaterialScreenshotFrame2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialScreenshotFrame2.displayName = 'OnesyIconMaterialScreenshotFrame2';

export default IconMaterialScreenshotFrame2;
