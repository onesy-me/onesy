...
const IconMaterialArrowAndEdgeW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowAndEdgeW100Filled'
...
IconMaterialArrowAndEdgeW100Filled.displayName = 'OnesyIconMaterialArrowAndEdgeW100Filled';

export default IconMaterialArrowAndEdgeW100Filled;
