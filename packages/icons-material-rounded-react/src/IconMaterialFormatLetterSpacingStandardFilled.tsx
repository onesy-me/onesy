...
const IconMaterialFormatLetterSpacingStandardFilled = (props: IIcon) => {
...
IconMaterialFormatLetterSpacingStandardFilled.displayName = 'OnesyIconMaterialFormatLetterSpacingStandardFilled';
