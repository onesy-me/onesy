...
const IconMaterialPortraitLightingOffFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PortraitLightingOffFilled'
...
IconMaterialPortraitLightingOffFilled.displayName = 'OnesyIconMaterialPortraitLightingOffFilled';

export default IconMaterialPortraitLightingOffFilled;
