...
const IconMaterialVitalsFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialVitalsFilled.displayName = 'OnesyIconMaterialVitalsFilled';

export default IconMaterialVitalsFilled;
