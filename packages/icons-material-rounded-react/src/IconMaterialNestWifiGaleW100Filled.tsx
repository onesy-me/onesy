...
const IconMaterialNestWifiGaleW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiGaleW100Filled'
...
IconMaterialNestWifiGaleW100Filled.displayName = 'OnesyIconMaterialNestWifiGaleW100Filled';

export default IconMaterialNestWifiGaleW100Filled;
