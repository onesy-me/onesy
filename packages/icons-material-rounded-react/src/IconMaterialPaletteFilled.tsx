...
const IconMaterialPaletteFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPaletteFilled.displayName = 'OnesyIconMaterialPaletteFilled';

export default IconMaterialPaletteFilled;
