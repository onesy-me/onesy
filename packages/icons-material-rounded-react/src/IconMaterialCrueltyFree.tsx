...
const IconMaterialCrueltyFree = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCrueltyFree.displayName = 'OnesyIconMaterialCrueltyFree';

export default IconMaterialCrueltyFree;
