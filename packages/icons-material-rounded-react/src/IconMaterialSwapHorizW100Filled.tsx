...
const IconMaterialSwapHorizW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SwapHorizW100Filled'
...
IconMaterialSwapHorizW100Filled.displayName = 'OnesyIconMaterialSwapHorizW100Filled';

export default IconMaterialSwapHorizW100Filled;
