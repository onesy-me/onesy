...
const IconMaterialTextRotationDownFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTextRotationDownFilled.displayName = 'OnesyIconMaterialTextRotationDownFilled';

export default IconMaterialTextRotationDownFilled;
