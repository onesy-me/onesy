...
const IconMaterialBatteryAndroidFrameShareFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAndroidFrameShareFilled'
...
IconMaterialBatteryAndroidFrameShareFilled.displayName = 'OnesyIconMaterialBatteryAndroidFrameShareFilled';

export default IconMaterialBatteryAndroidFrameShareFilled;
