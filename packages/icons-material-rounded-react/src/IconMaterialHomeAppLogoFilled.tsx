...
const IconMaterialHomeAppLogoFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='HomeAppLogoFilled'
...
IconMaterialHomeAppLogoFilled.displayName = 'OnesyIconMaterialHomeAppLogoFilled';

export default IconMaterialHomeAppLogoFilled;
