...
const IconMaterialInfraredFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialInfraredFilled.displayName = 'OnesyIconMaterialInfraredFilled';

export default IconMaterialInfraredFilled;
