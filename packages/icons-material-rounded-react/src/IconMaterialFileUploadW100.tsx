...
const IconMaterialFileUploadW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFileUploadW100.displayName = 'OnesyIconMaterialFileUploadW100';

export default IconMaterialFileUploadW100;
