...
const IconMaterialModeCoolW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialModeCoolW100.displayName = 'OnesyIconMaterialModeCoolW100';

export default IconMaterialModeCoolW100;
