...
const IconMaterialJoinRightW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='JoinRightW100Filled'
...
IconMaterialJoinRightW100Filled.displayName = 'OnesyIconMaterialJoinRightW100Filled';

export default IconMaterialJoinRightW100Filled;
