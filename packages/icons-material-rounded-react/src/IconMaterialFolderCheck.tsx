...
const IconMaterialFolderCheck = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFolderCheck.displayName = 'OnesyIconMaterialFolderCheck';

export default IconMaterialFolderCheck;
