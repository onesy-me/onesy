...
const IconMaterialThermostatAutoW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatAutoW100'
...
IconMaterialThermostatAutoW100.displayName = 'OnesyIconMaterialThermostatAutoW100';

export default IconMaterialThermostatAutoW100;
