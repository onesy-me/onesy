...
const IconMaterialArrowUploadProgressFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowUploadProgressFilled'
...
IconMaterialArrowUploadProgressFilled.displayName = 'OnesyIconMaterialArrowUploadProgressFilled';

export default IconMaterialArrowUploadProgressFilled;
