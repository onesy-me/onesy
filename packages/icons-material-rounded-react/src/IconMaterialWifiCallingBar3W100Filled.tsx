...
const IconMaterialWifiCallingBar3W100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiCallingBar3W100Filled'
...
IconMaterialWifiCallingBar3W100Filled.displayName = 'OnesyIconMaterialWifiCallingBar3W100Filled';

export default IconMaterialWifiCallingBar3W100Filled;
