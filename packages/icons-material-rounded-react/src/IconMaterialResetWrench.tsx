...
const IconMaterialResetWrench = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialResetWrench.displayName = 'OnesyIconMaterialResetWrench';

export default IconMaterialResetWrench;
