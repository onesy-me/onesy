...
const IconMaterialOrthopedicsFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='OrthopedicsFilled'
...
IconMaterialOrthopedicsFilled.displayName = 'OnesyIconMaterialOrthopedicsFilled';

export default IconMaterialOrthopedicsFilled;
