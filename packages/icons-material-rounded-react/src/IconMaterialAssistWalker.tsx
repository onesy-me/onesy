...
const IconMaterialAssistWalker = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAssistWalker.displayName = 'OnesyIconMaterialAssistWalker';

export default IconMaterialAssistWalker;
