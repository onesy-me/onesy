...
const IconMaterialHotTubFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHotTubFilled.displayName = 'OnesyIconMaterialHotTubFilled';

export default IconMaterialHotTubFilled;
