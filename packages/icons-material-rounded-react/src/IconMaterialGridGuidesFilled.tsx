...
const IconMaterialGridGuidesFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='GridGuidesFilled'
...
IconMaterialGridGuidesFilled.displayName = 'OnesyIconMaterialGridGuidesFilled';

export default IconMaterialGridGuidesFilled;
