...
const IconMaterialNestProtectW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestProtectW100Filled'
...
IconMaterialNestProtectW100Filled.displayName = 'OnesyIconMaterialNestProtectW100Filled';

export default IconMaterialNestProtectW100Filled;
