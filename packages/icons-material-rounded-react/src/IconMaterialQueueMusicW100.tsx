...
const IconMaterialQueueMusicW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialQueueMusicW100.displayName = 'OnesyIconMaterialQueueMusicW100';

export default IconMaterialQueueMusicW100;
