...
const IconMaterialPortraitLightingW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PortraitLightingW100Filled'
...
export default IconMaterialPortraitLightingW100Filled;
