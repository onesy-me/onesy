...
const IconMaterialTimerPause = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTimerPause.displayName = 'OnesyIconMaterialTimerPause';

export default IconMaterialTimerPause;
