...
const IconMaterialEvChargerFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EvChargerFilled'
...
IconMaterialEvChargerFilled.displayName = 'OnesyIconMaterialEvChargerFilled';

export default IconMaterialEvChargerFilled;
