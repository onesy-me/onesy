...
const IconMaterialChildHat = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialChildHat.displayName = 'OnesyIconMaterialChildHat';

export default IconMaterialChildHat;
