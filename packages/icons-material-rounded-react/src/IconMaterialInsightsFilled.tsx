...
const IconMaterialInsightsFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialInsightsFilled.displayName = 'OnesyIconMaterialInsightsFilled';

export default IconMaterialInsightsFilled;
