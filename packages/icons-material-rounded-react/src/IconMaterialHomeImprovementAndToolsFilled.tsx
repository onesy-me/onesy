...
const IconMaterialHomeImprovementAndToolsFilled = (props: IIcon) => {
...
IconMaterialHomeImprovementAndToolsFilled.displayName = 'OnesyIconMaterialHomeImprovementAndToolsFilled';
