...
const IconMaterialConnectWithoutContactFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ConnectWithoutContactFilled'
...
IconMaterialConnectWithoutContactFilled.displayName = 'OnesyIconMaterialConnectWithoutContactFilled';

export default IconMaterialConnectWithoutContactFilled;
