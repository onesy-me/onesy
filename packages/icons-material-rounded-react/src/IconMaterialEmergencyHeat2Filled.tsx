...
const IconMaterialEmergencyHeat2Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='EmergencyHeat2Filled'
