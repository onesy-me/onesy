...
const IconMaterialPublishedWithChangesW100Filled = (props: IIcon) => {
...
IconMaterialPublishedWithChangesW100Filled.displayName = 'OnesyIconMaterialPublishedWithChangesW100Filled';
