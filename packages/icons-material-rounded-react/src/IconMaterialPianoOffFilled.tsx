...
const IconMaterialPianoOffFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPianoOffFilled.displayName = 'OnesyIconMaterialPianoOffFilled';

export default IconMaterialPianoOffFilled;
