...
const IconMaterialStrokePartialFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='StrokePartialFilled'
...
IconMaterialStrokePartialFilled.displayName = 'OnesyIconMaterialStrokePartialFilled';

export default IconMaterialStrokePartialFilled;
