...
const IconMaterialSpeed12x = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSpeed12x.displayName = 'OnesyIconMaterialSpeed12x';

export default IconMaterialSpeed12x;
