...
const IconMaterialSettingsAccessibilityFilled = (props: IIcon) => {
...
IconMaterialSettingsAccessibilityFilled.displayName = 'OnesyIconMaterialSettingsAccessibilityFilled';
