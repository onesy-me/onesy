...
const IconMaterialChairUmbrellaW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ChairUmbrellaW100Filled'
