...
const IconMaterialLocalGasStationW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalGasStationW100Filled'
...
IconMaterialLocalGasStationW100Filled.displayName = 'OnesyIconMaterialLocalGasStationW100Filled';

export default IconMaterialLocalGasStationW100Filled;
