...
const IconMaterialSunnyFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSunnyFilled.displayName = 'OnesyIconMaterialSunnyFilled';

export default IconMaterialSunnyFilled;
