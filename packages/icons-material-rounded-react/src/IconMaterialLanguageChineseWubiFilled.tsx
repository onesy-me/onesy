...
const IconMaterialLanguageChineseWubiFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LanguageChineseWubiFilled'
...
export default IconMaterialLanguageChineseWubiFilled;
