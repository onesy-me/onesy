...
const IconMaterialNestConnectW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestConnectW100Filled'
...
IconMaterialNestConnectW100Filled.displayName = 'OnesyIconMaterialNestConnectW100Filled';

export default IconMaterialNestConnectW100Filled;
