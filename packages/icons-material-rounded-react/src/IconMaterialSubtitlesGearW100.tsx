...
const IconMaterialSubtitlesGearW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SubtitlesGearW100'
