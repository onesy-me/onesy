...
const IconMaterialAlbumW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAlbumW100.displayName = 'OnesyIconMaterialAlbumW100';

export default IconMaterialAlbumW100;
