...
const IconMaterialGoogleTvRemoteFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='GoogleTvRemoteFilled'
...
IconMaterialGoogleTvRemoteFilled.displayName = 'OnesyIconMaterialGoogleTvRemoteFilled';

export default IconMaterialGoogleTvRemoteFilled;
