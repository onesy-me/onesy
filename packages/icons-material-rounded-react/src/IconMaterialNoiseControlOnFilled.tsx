...
const IconMaterialNoiseControlOnFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NoiseControlOnFilled'
...
IconMaterialNoiseControlOnFilled.displayName = 'OnesyIconMaterialNoiseControlOnFilled';

export default IconMaterialNoiseControlOnFilled;
