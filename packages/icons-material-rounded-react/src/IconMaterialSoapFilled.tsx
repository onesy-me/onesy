...
const IconMaterialSoapFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSoapFilled.displayName = 'OnesyIconMaterialSoapFilled';

export default IconMaterialSoapFilled;
