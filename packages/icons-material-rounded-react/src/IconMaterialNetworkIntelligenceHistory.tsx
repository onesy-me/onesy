...
const IconMaterialNetworkIntelligenceHistory = (props: IIcon) => {
...
IconMaterialNetworkIntelligenceHistory.displayName = 'OnesyIconMaterialNetworkIntelligenceHistory';
