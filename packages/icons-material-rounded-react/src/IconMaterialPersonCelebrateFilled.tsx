...
const IconMaterialPersonCelebrateFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPersonCelebrateFilled.displayName = 'OnesyIconMaterialPersonCelebrateFilled';

export default IconMaterialPersonCelebrateFilled;
