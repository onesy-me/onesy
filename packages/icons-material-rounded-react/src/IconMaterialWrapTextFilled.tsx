...
const IconMaterialWrapTextFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWrapTextFilled.displayName = 'OnesyIconMaterialWrapTextFilled';

export default IconMaterialWrapTextFilled;
