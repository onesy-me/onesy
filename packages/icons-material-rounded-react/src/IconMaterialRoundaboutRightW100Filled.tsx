...
const IconMaterialRoundaboutRightW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RoundaboutRightW100Filled'
...
IconMaterialRoundaboutRightW100Filled.displayName = 'OnesyIconMaterialRoundaboutRightW100Filled';

export default IconMaterialRoundaboutRightW100Filled;
