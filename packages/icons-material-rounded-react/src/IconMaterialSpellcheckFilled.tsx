...
const IconMaterialSpellcheckFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SpellcheckFilled'
...
IconMaterialSpellcheckFilled.displayName = 'OnesyIconMaterialSpellcheckFilled';

export default IconMaterialSpellcheckFilled;
