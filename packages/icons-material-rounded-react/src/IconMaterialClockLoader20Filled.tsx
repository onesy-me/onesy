...
const IconMaterialClockLoader20Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialClockLoader20Filled.displayName = 'OnesyIconMaterialClockLoader20Filled';

export default IconMaterialClockLoader20Filled;
