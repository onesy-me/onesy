...
const IconMaterialTransferWithinAStationFilled = (props: IIcon) => {
...
IconMaterialTransferWithinAStationFilled.displayName = 'OnesyIconMaterialTransferWithinAStationFilled';
