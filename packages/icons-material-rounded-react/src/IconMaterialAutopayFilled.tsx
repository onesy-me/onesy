...
const IconMaterialAutopayFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAutopayFilled.displayName = 'OnesyIconMaterialAutopayFilled';

export default IconMaterialAutopayFilled;
