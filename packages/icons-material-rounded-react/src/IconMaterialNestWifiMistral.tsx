...
const IconMaterialNestWifiMistral = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestWifiMistral'
...
IconMaterialNestWifiMistral.displayName = 'OnesyIconMaterialNestWifiMistral';

export default IconMaterialNestWifiMistral;
