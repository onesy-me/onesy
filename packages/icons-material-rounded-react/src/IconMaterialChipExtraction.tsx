...
const IconMaterialChipExtraction = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialChipExtraction.displayName = 'OnesyIconMaterialChipExtraction';

export default IconMaterialChipExtraction;
