...
const IconMaterialAirwareFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAirwareFilled.displayName = 'OnesyIconMaterialAirwareFilled';

export default IconMaterialAirwareFilled;
