...
const IconMaterialStorefrontFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='StorefrontFilled'
...
IconMaterialStorefrontFilled.displayName = 'OnesyIconMaterialStorefrontFilled';

export default IconMaterialStorefrontFilled;
