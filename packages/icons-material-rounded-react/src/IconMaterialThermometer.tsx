...
const IconMaterialThermometer = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialThermometer.displayName = 'OnesyIconMaterialThermometer';

export default IconMaterialThermometer;
