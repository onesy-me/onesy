...
const IconMaterialPlumbing = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPlumbing.displayName = 'OnesyIconMaterialPlumbing';

export default IconMaterialPlumbing;
