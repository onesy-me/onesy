...
const IconMaterialSendMoney = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSendMoney.displayName = 'OnesyIconMaterialSendMoney';

export default IconMaterialSendMoney;
