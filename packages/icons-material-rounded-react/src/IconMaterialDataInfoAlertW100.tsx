...
const IconMaterialDataInfoAlertW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DataInfoAlertW100'
