...
const IconMaterialHistoryFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHistoryFilled.displayName = 'OnesyIconMaterialHistoryFilled';

export default IconMaterialHistoryFilled;
