...
const IconMaterialVerticalShadesClosedFilled = (props: IIcon) => {
...
IconMaterialVerticalShadesClosedFilled.displayName = 'OnesyIconMaterialVerticalShadesClosedFilled';
