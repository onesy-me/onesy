...
const IconMaterialCrueltyFreeFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CrueltyFreeFilled'
...
IconMaterialCrueltyFreeFilled.displayName = 'OnesyIconMaterialCrueltyFreeFilled';

export default IconMaterialCrueltyFreeFilled;
