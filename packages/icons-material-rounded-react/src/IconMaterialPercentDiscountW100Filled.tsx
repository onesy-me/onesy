...
const IconMaterialPercentDiscountW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PercentDiscountW100Filled'
