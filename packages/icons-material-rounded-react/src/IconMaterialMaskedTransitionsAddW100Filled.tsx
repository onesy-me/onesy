...
const IconMaterialMaskedTransitionsAddW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MaskedTransitionsAddW100Filled'
...
IconMaterialMaskedTransitionsAddW100Filled.displayName = 'OnesyIconMaterialMaskedTransitionsAddW100Filled';

export default IconMaterialMaskedTransitionsAddW100Filled;
