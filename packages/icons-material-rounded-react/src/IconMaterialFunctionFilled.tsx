...
const IconMaterialFunctionFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFunctionFilled.displayName = 'OnesyIconMaterialFunctionFilled';

export default IconMaterialFunctionFilled;
