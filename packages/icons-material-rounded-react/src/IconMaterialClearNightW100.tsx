...
const IconMaterialClearNightW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialClearNightW100.displayName = 'OnesyIconMaterialClearNightW100';

export default IconMaterialClearNightW100;
