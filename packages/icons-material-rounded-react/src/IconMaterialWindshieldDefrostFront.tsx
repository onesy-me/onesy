...
const IconMaterialWindshieldDefrostFront = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialWindshieldDefrostFront.displayName = 'OnesyIconMaterialWindshieldDefrostFront';

export default IconMaterialWindshieldDefrostFront;
