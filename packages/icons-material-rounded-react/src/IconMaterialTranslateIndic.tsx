...
const IconMaterialTranslateIndic = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTranslateIndic.displayName = 'OnesyIconMaterialTranslateIndic';

export default IconMaterialTranslateIndic;
