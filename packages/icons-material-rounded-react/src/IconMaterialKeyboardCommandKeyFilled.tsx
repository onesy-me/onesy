...
const IconMaterialKeyboardCommandKeyFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='KeyboardCommandKeyFilled'
...
IconMaterialKeyboardCommandKeyFilled.displayName = 'OnesyIconMaterialKeyboardCommandKeyFilled';

export default IconMaterialKeyboardCommandKeyFilled;
