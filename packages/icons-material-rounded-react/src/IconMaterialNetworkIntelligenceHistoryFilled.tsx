...
const IconMaterialNetworkIntelligenceHistoryFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NetworkIntelligenceHistoryFilled'
