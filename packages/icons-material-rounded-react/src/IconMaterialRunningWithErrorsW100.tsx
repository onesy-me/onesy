...
const IconMaterialRunningWithErrorsW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RunningWithErrorsW100'
...
IconMaterialRunningWithErrorsW100.displayName = 'OnesyIconMaterialRunningWithErrorsW100';

export default IconMaterialRunningWithErrorsW100;
