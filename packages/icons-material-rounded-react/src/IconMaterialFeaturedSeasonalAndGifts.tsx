...
const IconMaterialFeaturedSeasonalAndGifts = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFeaturedSeasonalAndGifts.displayName = 'OnesyIconMaterialFeaturedSeasonalAndGifts';

export default IconMaterialFeaturedSeasonalAndGifts;
