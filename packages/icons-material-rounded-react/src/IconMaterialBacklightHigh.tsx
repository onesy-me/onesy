...
const IconMaterialBacklightHigh = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBacklightHigh.displayName = 'OnesyIconMaterialBacklightHigh';

export default IconMaterialBacklightHigh;
