...
const IconMaterialLanguageChineseQuickFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LanguageChineseQuickFilled'
