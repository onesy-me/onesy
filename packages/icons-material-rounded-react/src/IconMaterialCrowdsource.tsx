...
const IconMaterialCrowdsource = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCrowdsource.displayName = 'OnesyIconMaterialCrowdsource';

export default IconMaterialCrowdsource;
