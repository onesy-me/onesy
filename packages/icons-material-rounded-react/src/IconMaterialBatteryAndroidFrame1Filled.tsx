...
const IconMaterialBatteryAndroidFrame1Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BatteryAndroidFrame1Filled'
...
IconMaterialBatteryAndroidFrame1Filled.displayName = 'OnesyIconMaterialBatteryAndroidFrame1Filled';

export default IconMaterialBatteryAndroidFrame1Filled;
