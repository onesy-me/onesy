...
const IconMaterialMaskedTransitionsAdd = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMaskedTransitionsAdd.displayName = 'OnesyIconMaterialMaskedTransitionsAdd';

export default IconMaterialMaskedTransitionsAdd;
