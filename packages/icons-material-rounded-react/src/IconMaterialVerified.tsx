...
const IconMaterialVerified = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialVerified.displayName = 'OnesyIconMaterialVerified';

export default IconMaterialVerified;
