...
const IconMaterialThermostatFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ThermostatFilled'
...
IconMaterialThermostatFilled.displayName = 'OnesyIconMaterialThermostatFilled';

export default IconMaterialThermostatFilled;
