...
const IconMaterialPokerChipW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PokerChipW100Filled'
...
IconMaterialPokerChipW100Filled.displayName = 'OnesyIconMaterialPokerChipW100Filled';

export default IconMaterialPokerChipW100Filled;
