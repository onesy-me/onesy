...
const IconMaterialMacroOffFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMacroOffFilled.displayName = 'OnesyIconMaterialMacroOffFilled';

export default IconMaterialMacroOffFilled;
