...
const IconMaterialCommunities = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialCommunities.displayName = 'OnesyIconMaterialCommunities';

export default IconMaterialCommunities;
