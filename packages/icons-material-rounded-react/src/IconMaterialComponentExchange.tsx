...
const IconMaterialComponentExchange = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialComponentExchange.displayName = 'OnesyIconMaterialComponentExchange';

export default IconMaterialComponentExchange;
