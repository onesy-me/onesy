...
const IconMaterialTonalityW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TonalityW100Filled'
...
IconMaterialTonalityW100Filled.displayName = 'OnesyIconMaterialTonalityW100Filled';

export default IconMaterialTonalityW100Filled;
