...
const IconMaterialMaskedTransitionsFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MaskedTransitionsFilled'
...
IconMaterialMaskedTransitionsFilled.displayName = 'OnesyIconMaterialMaskedTransitionsFilled';

export default IconMaterialMaskedTransitionsFilled;
