...
const IconMaterialRegularExpressionW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='RegularExpressionW100Filled'
