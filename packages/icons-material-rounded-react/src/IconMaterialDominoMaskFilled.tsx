...
const IconMaterialDominoMaskFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='DominoMaskFilled'
...
IconMaterialDominoMaskFilled.displayName = 'OnesyIconMaterialDominoMaskFilled';

export default IconMaterialDominoMaskFilled;
