...
const IconMaterialHistory2Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHistory2Filled.displayName = 'OnesyIconMaterialHistory2Filled';

export default IconMaterialHistory2Filled;
