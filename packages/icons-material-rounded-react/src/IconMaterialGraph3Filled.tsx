...
const IconMaterialGraph3Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGraph3Filled.displayName = 'OnesyIconMaterialGraph3Filled';

export default IconMaterialGraph3Filled;
