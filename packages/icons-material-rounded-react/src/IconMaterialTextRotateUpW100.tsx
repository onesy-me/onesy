...
const IconMaterialTextRotateUpW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='TextRotateUpW100'
...
IconMaterialTextRotateUpW100.displayName = 'OnesyIconMaterialTextRotateUpW100';

export default IconMaterialTextRotateUpW100;
