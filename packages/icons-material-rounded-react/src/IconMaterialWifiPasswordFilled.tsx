...
const IconMaterialWifiPasswordFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='WifiPasswordFilled'
...
IconMaterialWifiPasswordFilled.displayName = 'OnesyIconMaterialWifiPasswordFilled';

export default IconMaterialWifiPasswordFilled;
