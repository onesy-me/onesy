...
const IconMaterialProductivity = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialProductivity.displayName = 'OnesyIconMaterialProductivity';

export default IconMaterialProductivity;
