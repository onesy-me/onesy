...
const IconMaterialKanjiAlcoholFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='KanjiAlcoholFilled'
