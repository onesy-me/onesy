...
const IconMaterialSensorsW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SensorsW100Filled'
...
IconMaterialSensorsW100Filled.displayName = 'OnesyIconMaterialSensorsW100Filled';

export default IconMaterialSensorsW100Filled;
