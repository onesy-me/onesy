...
const IconMaterialRemoteGen = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialRemoteGen.displayName = 'OnesyIconMaterialRemoteGen';

export default IconMaterialRemoteGen;
