...
const IconMaterialArrowShapeUpStack2W100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ArrowShapeUpStack2W100Filled'
