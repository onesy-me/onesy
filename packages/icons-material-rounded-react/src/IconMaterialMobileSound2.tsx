...
const IconMaterialMobileSound2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMobileSound2.displayName = 'OnesyIconMaterialMobileSound2';

export default IconMaterialMobileSound2;
