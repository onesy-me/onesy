...
const IconMaterialSteppersFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSteppersFilled.displayName = 'OnesyIconMaterialSteppersFilled';

export default IconMaterialSteppersFilled;
