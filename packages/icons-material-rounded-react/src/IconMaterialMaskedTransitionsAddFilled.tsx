...
const IconMaterialMaskedTransitionsAddFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MaskedTransitionsAddFilled'
...
IconMaterialMaskedTransitionsAddFilled.displayName = 'OnesyIconMaterialMaskedTransitionsAddFilled';

export default IconMaterialMaskedTransitionsAddFilled;
