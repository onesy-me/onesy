...
const IconMaterialGlobeBook = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGlobeBook.displayName = 'OnesyIconMaterialGlobeBook';

export default IconMaterialGlobeBook;
