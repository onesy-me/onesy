...
const IconMaterialContentPasteSearchFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ContentPasteSearchFilled'
...
IconMaterialContentPasteSearchFilled.displayName = 'OnesyIconMaterialContentPasteSearchFilled';

export default IconMaterialContentPasteSearchFilled;
