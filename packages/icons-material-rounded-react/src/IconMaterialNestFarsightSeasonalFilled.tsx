...
const IconMaterialNestFarsightSeasonalFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightSeasonalFilled'
...
IconMaterialNestFarsightSeasonalFilled.displayName = 'OnesyIconMaterialNestFarsightSeasonalFilled';

export default IconMaterialNestFarsightSeasonalFilled;
