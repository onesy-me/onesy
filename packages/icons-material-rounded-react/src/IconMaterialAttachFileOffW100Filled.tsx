...
const IconMaterialAttachFileOffW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AttachFileOffW100Filled'
...
IconMaterialAttachFileOffW100Filled.displayName = 'OnesyIconMaterialAttachFileOffW100Filled';

export default IconMaterialAttachFileOffW100Filled;
