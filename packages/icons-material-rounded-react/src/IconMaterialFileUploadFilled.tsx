...
const IconMaterialFileUploadFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFileUploadFilled.displayName = 'OnesyIconMaterialFileUploadFilled';

export default IconMaterialFileUploadFilled;
