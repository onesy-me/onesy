...
const IconMaterialIndeterminateQuestionBoxW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='IndeterminateQuestionBoxW100'
...
IconMaterialIndeterminateQuestionBoxW100.displayName = 'OnesyIconMaterialIndeterminateQuestionBoxW100';

export default IconMaterialIndeterminateQuestionBoxW100;
