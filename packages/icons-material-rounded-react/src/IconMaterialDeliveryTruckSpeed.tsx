...
const IconMaterialDeliveryTruckSpeed = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDeliveryTruckSpeed.displayName = 'OnesyIconMaterialDeliveryTruckSpeed';

export default IconMaterialDeliveryTruckSpeed;
