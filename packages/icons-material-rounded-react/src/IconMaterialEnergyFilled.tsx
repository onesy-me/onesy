...
const IconMaterialEnergyFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialEnergyFilled.displayName = 'OnesyIconMaterialEnergyFilled';

export default IconMaterialEnergyFilled;
