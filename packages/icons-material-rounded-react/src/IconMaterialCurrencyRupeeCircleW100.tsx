...
const IconMaterialCurrencyRupeeCircleW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CurrencyRupeeCircleW100'
