...
const IconMaterialDesktopCloudStack = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDesktopCloudStack.displayName = 'OnesyIconMaterialDesktopCloudStack';

export default IconMaterialDesktopCloudStack;
