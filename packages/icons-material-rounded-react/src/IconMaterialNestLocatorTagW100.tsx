...
const IconMaterialNestLocatorTagW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestLocatorTagW100'
