...
const IconMaterialFormatParagraph = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFormatParagraph.displayName = 'OnesyIconMaterialFormatParagraph';

export default IconMaterialFormatParagraph;
