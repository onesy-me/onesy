...
const IconMaterialFanFocusFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFanFocusFilled.displayName = 'OnesyIconMaterialFanFocusFilled';

export default IconMaterialFanFocusFilled;
