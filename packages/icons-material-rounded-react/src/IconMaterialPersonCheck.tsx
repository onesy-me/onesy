...
const IconMaterialPersonCheck = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPersonCheck.displayName = 'OnesyIconMaterialPersonCheck';

export default IconMaterialPersonCheck;
