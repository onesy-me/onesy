...
const IconMaterialBabyChangingStationFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='BabyChangingStationFilled'
...
IconMaterialBabyChangingStationFilled.displayName = 'OnesyIconMaterialBabyChangingStationFilled';

export default IconMaterialBabyChangingStationFilled;
