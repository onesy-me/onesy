...
const IconMaterialDashboard2 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDashboard2.displayName = 'OnesyIconMaterialDashboard2';

export default IconMaterialDashboard2;
