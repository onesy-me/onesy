...
const IconMaterialArrowSplit = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialArrowSplit.displayName = 'OnesyIconMaterialArrowSplit';

export default IconMaterialArrowSplit;
