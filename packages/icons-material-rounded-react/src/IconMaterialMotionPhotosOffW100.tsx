...
const IconMaterialMotionPhotosOffW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionPhotosOffW100'
...
IconMaterialMotionPhotosOffW100.displayName = 'OnesyIconMaterialMotionPhotosOffW100';

export default IconMaterialMotionPhotosOffW100;
