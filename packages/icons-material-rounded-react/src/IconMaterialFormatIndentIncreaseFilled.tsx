...
const IconMaterialFormatIndentIncreaseFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFormatIndentIncreaseFilled.displayName = 'OnesyIconMaterialFormatIndentIncreaseFilled';

export default IconMaterialFormatIndentIncreaseFilled;
