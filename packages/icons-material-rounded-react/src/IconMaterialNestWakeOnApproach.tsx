...
const IconMaterialNestWakeOnApproach = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestWakeOnApproach.displayName = 'OnesyIconMaterialNestWakeOnApproach';

export default IconMaterialNestWakeOnApproach;
