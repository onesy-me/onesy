...
const IconMaterialCarFanMidLeftW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='CarFanMidLeftW100'
