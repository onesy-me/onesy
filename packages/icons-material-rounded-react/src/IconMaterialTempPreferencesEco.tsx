...
const IconMaterialTempPreferencesEco = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTempPreferencesEco.displayName = 'OnesyIconMaterialTempPreferencesEco';

export default IconMaterialTempPreferencesEco;
