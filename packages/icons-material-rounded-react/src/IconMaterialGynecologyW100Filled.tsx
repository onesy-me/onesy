...
const IconMaterialGynecologyW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='GynecologyW100Filled'
