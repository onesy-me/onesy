...
const IconMaterialFanIndirectFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FanIndirectFilled'
