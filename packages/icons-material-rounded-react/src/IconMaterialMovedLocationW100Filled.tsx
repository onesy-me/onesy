...
const IconMaterialMovedLocationW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MovedLocationW100Filled'
...
IconMaterialMovedLocationW100Filled.displayName = 'OnesyIconMaterialMovedLocationW100Filled';

export default IconMaterialMovedLocationW100Filled;
