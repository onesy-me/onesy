...
const IconMaterialGlobeW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGlobeW100.displayName = 'OnesyIconMaterialGlobeW100';

export default IconMaterialGlobeW100;
