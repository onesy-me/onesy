...
const IconMaterialAlternateEmailW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AlternateEmailW100'
