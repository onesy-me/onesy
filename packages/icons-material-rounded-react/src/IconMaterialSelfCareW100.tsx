...
const IconMaterialSelfCareW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSelfCareW100.displayName = 'OnesyIconMaterialSelfCareW100';

export default IconMaterialSelfCareW100;
