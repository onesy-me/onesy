...
const IconMaterialSearchCheckW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SearchCheckW100Filled'
...
IconMaterialSearchCheckW100Filled.displayName = 'OnesyIconMaterialSearchCheckW100Filled';

export default IconMaterialSearchCheckW100Filled;
