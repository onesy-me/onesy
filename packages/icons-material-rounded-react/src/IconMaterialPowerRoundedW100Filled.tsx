...
const IconMaterialPowerRoundedW100Filled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialPowerRoundedW100Filled.displayName = 'OnesyIconMaterialPowerRoundedW100Filled';
