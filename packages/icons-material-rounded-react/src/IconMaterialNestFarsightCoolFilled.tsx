...
const IconMaterialNestFarsightCoolFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='NestFarsightCoolFilled'
...
IconMaterialNestFarsightCoolFilled.displayName = 'OnesyIconMaterialNestFarsightCoolFilled';

export default IconMaterialNestFarsightCoolFilled;
