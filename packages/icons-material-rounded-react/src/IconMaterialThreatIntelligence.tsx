...
const IconMaterialThreatIntelligence = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialThreatIntelligence.displayName = 'OnesyIconMaterialThreatIntelligence';

export default IconMaterialThreatIntelligence;
