...
const IconMaterialFilterTiltShiftFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FilterTiltShiftFilled'
