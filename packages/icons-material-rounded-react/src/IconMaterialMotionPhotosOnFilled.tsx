...
const IconMaterialMotionPhotosOnFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='MotionPhotosOnFilled'
...
IconMaterialMotionPhotosOnFilled.displayName = 'OnesyIconMaterialMotionPhotosOnFilled';

export default IconMaterialMotionPhotosOnFilled;
