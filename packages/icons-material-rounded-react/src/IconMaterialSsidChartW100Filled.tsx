...
const IconMaterialSsidChartW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='SsidChartW100Filled'
...
IconMaterialSsidChartW100Filled.displayName = 'OnesyIconMaterialSsidChartW100Filled';

export default IconMaterialSsidChartW100Filled;
