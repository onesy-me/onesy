...
const IconMaterialReplaceAudioW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ReplaceAudioW100'
...
IconMaterialReplaceAudioW100.displayName = 'OnesyIconMaterialReplaceAudioW100';

export default IconMaterialReplaceAudioW100;
