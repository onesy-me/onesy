...
const IconMaterialLocalConvenienceStoreW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='LocalConvenienceStoreW100'
