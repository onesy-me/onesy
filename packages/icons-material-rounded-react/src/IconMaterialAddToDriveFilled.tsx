...
const IconMaterialAddToDriveFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='AddToDriveFilled'
...
IconMaterialAddToDriveFilled.displayName = 'OnesyIconMaterialAddToDriveFilled';

export default IconMaterialAddToDriveFilled;
