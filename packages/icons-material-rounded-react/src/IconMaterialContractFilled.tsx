...
const IconMaterialContractFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialContractFilled.displayName = 'OnesyIconMaterialContractFilled';

export default IconMaterialContractFilled;
