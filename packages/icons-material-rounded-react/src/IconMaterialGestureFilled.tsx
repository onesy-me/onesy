...
const IconMaterialGestureFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGestureFilled.displayName = 'OnesyIconMaterialGestureFilled';

export default IconMaterialGestureFilled;
