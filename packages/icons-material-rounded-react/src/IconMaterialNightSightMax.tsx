...
const IconMaterialNightSightMax = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNightSightMax.displayName = 'OnesyIconMaterialNightSightMax';

export default IconMaterialNightSightMax;
