...
const IconMaterialHanamiDangoFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='HanamiDangoFilled'
