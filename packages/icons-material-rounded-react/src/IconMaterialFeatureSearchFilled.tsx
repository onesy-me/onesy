...
const IconMaterialFeatureSearchFilled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='FeatureSearchFilled'
...
IconMaterialFeatureSearchFilled.displayName = 'OnesyIconMaterialFeatureSearchFilled';

export default IconMaterialFeatureSearchFilled;
