...
const IconMaterialGroupWorkW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialGroupWorkW100.displayName = 'OnesyIconMaterialGroupWorkW100';

export default IconMaterialGroupWorkW100;
