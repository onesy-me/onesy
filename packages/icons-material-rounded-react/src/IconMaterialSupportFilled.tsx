...
const IconMaterialSupportFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSupportFilled.displayName = 'OnesyIconMaterialSupportFilled';

export default IconMaterialSupportFilled;
