...
const IconMaterialErrorCircleRoundedW100Filled = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='ErrorCircleRoundedW100Filled'
...
IconMaterialErrorCircleRoundedW100Filled.displayName = 'OnesyIconMaterialErrorCircleRoundedW100Filled';

export default IconMaterialErrorCircleRoundedW100Filled;
