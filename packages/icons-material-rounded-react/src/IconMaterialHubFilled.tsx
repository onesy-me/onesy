...
const IconMaterialHubFilled = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHubFilled.displayName = 'OnesyIconMaterialHubFilled';

export default IconMaterialHubFilled;
