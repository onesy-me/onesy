...
const IconMaterialBidLandscapeDisabledFilled = (props: IIcon) => {
...
IconMaterialBidLandscapeDisabledFilled.displayName = 'OnesyIconMaterialBidLandscapeDisabledFilled';
