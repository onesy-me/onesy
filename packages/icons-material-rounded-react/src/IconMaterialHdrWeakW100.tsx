...
const IconMaterialHdrWeakW100 = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHdrWeakW100.displayName = 'OnesyIconMaterialHdrWeakW100';

export default IconMaterialHdrWeakW100;
