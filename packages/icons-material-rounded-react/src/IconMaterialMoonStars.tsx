...
const IconMaterialMoonStars = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialMoonStars.displayName = 'OnesyIconMaterialMoonStars';

export default IconMaterialMoonStars;
