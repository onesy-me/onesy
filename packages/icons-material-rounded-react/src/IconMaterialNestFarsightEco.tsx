...
const IconMaterialNestFarsightEco = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialNestFarsightEco.displayName = 'OnesyIconMaterialNestFarsightEco';

export default IconMaterialNestFarsightEco;
