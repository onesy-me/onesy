...
const IconMaterialFestival = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialFestival.displayName = 'OnesyIconMaterialFestival';

export default IconMaterialFestival;
