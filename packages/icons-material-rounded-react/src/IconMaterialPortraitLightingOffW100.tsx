...
const IconMaterialPortraitLightingOffW100 = React.forwardRef((props: IIcon, ref) => {

  return (
    <Icon
      ref={ref}

      name='PortraitLightingOffW100'
...
IconMaterialPortraitLightingOffW100.displayName = 'OnesyIconMaterialPortraitLightingOffW100';

export default IconMaterialPortraitLightingOffW100;
