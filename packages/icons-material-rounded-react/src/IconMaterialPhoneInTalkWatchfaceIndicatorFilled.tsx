...
const IconMaterialPhoneInTalkWatchfaceIndicatorFilled = (props: IIcon) => {
...
IconMaterialPhoneInTalkWatchfaceIndicatorFilled.displayName = 'OnesyIconMaterialPhoneInTalkWatchfaceIndicatorFilled';
