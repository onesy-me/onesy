...
`;
      ...
      const regExpressions = (options = { level: 1 }) => {
        const {
          level
        } = options;
      ...
      const method = (valueNew_: string, options: any = { level: 1 }) => {
      ...
      const listItem = (valueListItem_: string, level = 1) => {
      ...
      const list = (valueList_: string, marker: string, level = 1) => {
