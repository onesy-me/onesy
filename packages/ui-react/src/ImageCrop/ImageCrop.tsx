...
import { is, clamp, isEnvironment } from '@onesy/utils';
...
const ImageCrop: React.FC<IImageCrop> = React.forwardRef((props_, ref: any) => {
  ...
  const refs = {
    ...
    selector: React.useRef<any>(null),
    imageSelectorMain: React.useRef<any>(null),
    imageSelector: React.useRef<any>(null),
    previousMouseEvent: React.useRef<any>(null),
    canvasMain: React.useRef<HTMLCanvasElement>(null),
    canvasImageSelector: React.useRef<HTMLCanvasElement>(null),
    move: React.useRef<HTMLDivElement>(null),
    borderTop: React.useRef<HTMLDivElement>(null),
    borderLeft: React.useRef<HTMLDivElement>(null),
    borderRight: React.useRef<HTMLDivElement>(null),
    borderBottom: React.useRef<HTMLDivElement>(null),
    dotTopLeft: React.useRef<HTMLDivElement>(null),
    dotTopRight: React.useRef<HTMLDivElement>(null),
    dotBottomLeft: React.useRef<HTMLDivElement>(null),
    dotBottomRight: React.useRef<HTMLDivElement>(null),
    props: React.useRef<any>(null),
    dynamicParent: React.useRef<any>(null),
    focus: React.useRef<any>(null),
    aspectRatio: React.useRef<any>(null)
  };
