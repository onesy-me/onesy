...
const IconCustomFacebook: React.FC<IIcon> = props => {
...
const IconCustomX: React.FC<IIcon> = props => {
...
const IconCustomLinkedin: React.FC<IIcon> = props => {
...
const IconCustomPinterest: React.FC<IIcon> = props => {
...
const IconCustomReddit: React.FC<IIcon> = props => {
...
const IconCustomWhatsapp: React.FC<IIcon> = props => {
...
const IconCustomViber: React.FC<IIcon> = props => {
...
const Share: React.FC<IShare> = props_ => {
