...
const Chart: React.FC<IChart> = props_ => {
  ...
  const refs = {
    ...
    defs: React.useRef<any>(undefined),
    minMax: React.useRef<any>(undefined),
    rects: React.useRef<any>(undefined),
    guidelines: React.useRef<any>(undefined),
    guidelinesIn: React.useRef<any>(undefined),
    guidelinesPosition: React.useRef<any>(undefined),
    guidelinesAppend: React.useRef<any>(undefined),
