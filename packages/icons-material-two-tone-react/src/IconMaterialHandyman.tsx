...
const IconMaterialHandyman = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialHandyman.displayName = 'OnesyIconMaterialHandyman';

export default IconMaterialHandyman;
