...
const IconMaterialTranslate = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialTranslate.displayName = 'OnesyIconMaterialTranslate';

export default IconMaterialTranslate;
