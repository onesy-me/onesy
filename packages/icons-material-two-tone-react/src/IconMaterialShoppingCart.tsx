...
const IconMaterialShoppingCart = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialShoppingCart.displayName = 'OnesyIconMaterialShoppingCart';

export default IconMaterialShoppingCart;
