...
const IconMaterialImageSearch = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialImageSearch.displayName = 'OnesyIconMaterialImageSearch';

export default IconMaterialImageSearch;
