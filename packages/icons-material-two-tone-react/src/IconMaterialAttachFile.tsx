...
const IconMaterialAttachFile = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAttachFile.displayName = 'OnesyIconMaterialAttachFile';

export default IconMaterialAttachFile;
