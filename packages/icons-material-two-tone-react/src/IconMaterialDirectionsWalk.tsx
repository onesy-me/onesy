...
const IconMaterialDirectionsWalk = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDirectionsWalk.displayName = 'OnesyIconMaterialDirectionsWalk';

export default IconMaterialDirectionsWalk;
