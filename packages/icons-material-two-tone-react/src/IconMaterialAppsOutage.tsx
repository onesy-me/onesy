...
const IconMaterialAppsOutage = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialAppsOutage.displayName = 'OnesyIconMaterialAppsOutage';

export default IconMaterialAppsOutage;
