...
const IconMaterialBlurCircular = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialBlurCircular.displayName = 'OnesyIconMaterialBlurCircular';

export default IconMaterialBlurCircular;
