...
const IconMaterialDownloading = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialDownloading.displayName = 'OnesyIconMaterialDownloading';

export default IconMaterialDownloading;
