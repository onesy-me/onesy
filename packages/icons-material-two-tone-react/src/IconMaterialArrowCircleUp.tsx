...
const IconMaterialArrowCircleUp = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialArrowCircleUp.displayName = 'OnesyIconMaterialArrowCircleUp';

export default IconMaterialArrowCircleUp;
