...
const IconMaterialSmokingRooms = React.forwardRef((props: IIcon, ref) => {
...
IconMaterialSmokingRooms.displayName = 'OnesyIconMaterialSmokingRooms';

export default IconMaterialSmokingRooms;
