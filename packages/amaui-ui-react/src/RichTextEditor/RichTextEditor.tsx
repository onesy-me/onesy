...
const RichTextEditor: React.FC<IRichTextEditor> = React.forwardRef((props__, ref: any) => {
  ...
  const refs = {
    ...
    selected: React.useRef<any>(undefined),
    miniMenu: React.useRef<any>(undefined),
    miniMenuInclude: React.useRef<any>(undefined),
    miniMenuElements: {
    ...
    elements: {
      ...
      linkAdd: React.useRef<any>(undefined),
      linkRemove: React.useRef<any>(undefined),
      quote: React.useRef<any>(undefined),
      image: React.useRef<any>(undefined),
      video: React.useRef<any>(undefined),
      videoYoutube: React.useRef<any>(undefined),
      table: React.useRef<any>(undefined),
      drawing: React.useRef<any>(undefined),
      drawingSvg: React.useRef<any>(undefined),
      drawingSize: React.useRef<any>(undefined),
      drawingSelect: React.useRef<any>(undefined),
      drawingPalette: React.useRef<any>(undefined),
      code: React.useRef<any>(undefined)
    },
