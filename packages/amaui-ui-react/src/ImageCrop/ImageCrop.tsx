...
const ImageCrop: React.FC<IImageCrop> = React.forwardRef((props_, ref: any) => {
  ...
  const refs = {
    ...
    move: React.useRef<HTMLDivElement>(undefined),
    borderTop: React.useRef<HTMLDivElement>(undefined),
    borderLeft: React.useRef<HTMLDivElement>(undefined),
    borderRight: React.useRef<HTMLDivElement>(undefined),
    borderBottom: React.useRef<HTMLDivElement>(undefined),
    dotTopLeft: React.useRef<HTMLDivElement>(undefined),
    dotTopRight: React.useRef<HTMLDivElement>(undefined),
    dotBottomLeft: React.useRef<HTMLDivElement>(undefined),
    dotBottomRight: React.useRef<HTMLDivElement>(undefined),
